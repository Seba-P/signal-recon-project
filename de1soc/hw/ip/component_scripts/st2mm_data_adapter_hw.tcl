...
# Fri May 18 16:24:34 CEST 2018
# DO NOT MODIFY


# 
# st2mm_data_adapter "st2mm_data_adapter" v2.0
#  2018.05.18.16:24:34
# 
# 
...
set_module_property NAME st2mm_data_adapter
set_module_property VERSION 2.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME st2mm_data_adapter
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL st2mm_data_adapter
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE true
add_fileset_file st2mm_data_adapter.sv SYSTEM_VERILOG PATH ../source/st2mm_data_adapter.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL st2mm_data_adapter
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE true
add_fileset_file st2mm_data_adapter.sv SYSTEM_VERILOG PATH ../source/st2mm_data_adapter.sv MENTOR_SPECIFIC
...
set_interface_property avalon_st_sink dataBitsPerSymbol 16
...
set_interface_property avalon_st_source dataBitsPerSymbol 8
...
add_interface_port avalon_st_source avalon_st_source_endofpacket endofpacket Output 1
add_interface_port avalon_st_source avalon_st_source_ready ready Input 1
add_interface_port avalon_st_source avalon_st_source_startofpacket startofpacket Output 1
add_interface_port avalon_st_source avalon_st_source_valid valid Output 1
add_interface_port avalon_st_source avalon_st_source_empty empty Output 1
