...
add_interface_port iter iter_iter_state new_signal Input 2
add_interface_port iter iter_iter_num new_signal_1 Input 5
add_interface_port iter iter_symbol_num new_signal_2 Input 8
add_interface_port iter iter_section_id new_signal_3 Input 2
add_interface_port iter iter_init new_signal_4 Input 1
add_interface_port iter iter_input_mux new_signal_5 Input 1
add_interface_port iter iter_input_enable new_signal_6 Input 1
add_interface_port iter iter_output_enable new_signal_7 Input 1
add_interface_port iter iter_ready new_signal_8 Output 1
