...
add_fileset_file limits_buffer_alt.v VERILOG PATH ../source/limits_buffer_alt.v
...
add_interface_port port_a port_a_address address Input 9
...
add_interface_port port_b port_b_address address Input 9
