...
# Tue May 29 13:12:48 CEST 2018
# DO NOT MODIFY


# 
# signal_buffer "signal_buffer" v1.0
#  2018.05.29.13:12:48
# 
# 
...
set_module_property NAME signal_buffer
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME signal_buffer
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL signal_buffer
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file signal_buffer.sv SYSTEM_VERILOG PATH ../source/signal_buffer.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL signal_buffer
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file signal_buffer.sv SYSTEM_VERILOG PATH ../source/signal_buffer.sv MENTOR_SPECIFIC
...
add_interface_port port_a port_a_address address Input 13
add_interface_port port_a port_a_chipselect chipselect Input 1
add_interface_port port_a port_a_read read Input 1
add_interface_port port_a port_a_readdata readdata Output 16
add_interface_port port_a port_a_write write Input 1
add_interface_port port_a port_a_writedata writedata Input 16
add_interface_port port_a port_a_byteenable byteenable Input 2
...
add_interface_port port_b port_b_address address Input 13
add_interface_port port_b port_b_chipselect chipselect Input 1
add_interface_port port_b port_b_read read Input 1
add_interface_port port_b port_b_readdata readdata Output 16
add_interface_port port_b port_b_write write Input 1
add_interface_port port_b port_b_writedata writedata Input 16
add_interface_port port_b port_b_byteenable byteenable Input 2
