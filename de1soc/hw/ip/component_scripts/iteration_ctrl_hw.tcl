...
add_interface_port sigbuff sigbuff_symbol_num new_signal_1 Output 8
add_interface_port sigbuff sigbuff_init new_signal_2 Output 1
add_interface_port sigbuff sigbuff_input_mux new_signal_3 Output 1
add_interface_port sigbuff sigbuff_input_enable new_signal_4 Output 1
add_interface_port sigbuff sigbuff_output_enable new_signal_5 Output 1
add_interface_port sigbuff sigbuff_ready new_signal_6 Input 1
...
add_interface_port limbuff limbuff_init new_signal_1 Output 1
add_interface_port limbuff limbuff_input_enable new_signal_2 Output 1
add_interface_port limbuff limbuff_output_enable new_signal_3 Output 1
add_interface_port limbuff limbuff_ready new_signal_4 Input 1
