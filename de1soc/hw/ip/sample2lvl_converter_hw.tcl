...
add_fileset_file sample2lvl_converter.v VERILOG PATH sample2lvl_converter.v TOP_LEVEL_FILE
...
# 
add_interface ram avalon start
set_interface_property ram addressUnits SYMBOLS
...
set_interface_property ram burstcountUnits SYMBOLS
set_interface_property ram doStreamReads false
set_interface_property ram doStreamWrites false
...
add_interface_port ram ram_address address Output 10
add_interface_port ram ram_chipselect chipselect Output 1
add_interface_port ram ram_read read Output 1
add_interface_port ram ram_write write Output 1
add_interface_port ram ram_readdata readdata Input 16
add_interface_port ram ram_writedata writedata Output 16
add_interface_port ram ram_byteenable byteenable Output 2
add_interface_port ram ram_waitrequest waitrequest Input 1
