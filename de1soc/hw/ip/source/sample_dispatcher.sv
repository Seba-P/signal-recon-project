...
// assign lvl_gen_new_sample = lvl_gen_new_sample_d1_r;
...
begin
  ...
  begin
    ...
    begin
      ...
      // lvl_gen_valid_r       <= lvl_duration_cnt_r > 'd1; // watch out for signed comparison
      lvl_gen_valid_r       <= lvl_duration_cnt_r > 'd1; // watch out for signed comparison
    ...
    // lvl_gen_new_sample_d1_r <= lvl_gen_new_sample_r;
  end
end
