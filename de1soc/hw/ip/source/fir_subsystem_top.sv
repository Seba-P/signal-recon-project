...
generate
  ...
  begin
    ...
    (
      .reset              (reset),                            //      reset.reset
      .clock              (clock),                            //      clock.clk
      .iter_new_limits    (iter_new_limits[ITER]),            //       iter.new_signal
      .iter_valid_signal  (iter_valid_signal[ITER]),          //           .new_signal_1
      .iter_input_enable  (iter_input_enable[ITER]),          //           .new_signal_2
      .iter_output_enable (iter_output_enable[ITER]),         //           .new_signal_3
      .iter_ready         (iter_ready[ITER]),                 //           .new_signal_4
