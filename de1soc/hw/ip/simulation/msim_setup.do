...
alias com_src {
  echo "\[exec\] com_src"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mm2st_data_adapter.sv"                                             -L altera_common_sv_packages -work mm2st_data_adapter                          
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/signal_buffer_alt.v"                                               -L altera_common_sv_packages -work signal_buffer_ctrl                            
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/limits_buffer_alt.v"                                               -L altera_common_sv_packages -work signal_buffer_ctrl                            
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/st2mm_data_adapter.sv"                                             -L altera_common_sv_packages -work st2mm_data_adapter                          
}
