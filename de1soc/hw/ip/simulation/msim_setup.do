...
alias com_src {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/signal_buffer.sv"                                                  -L altera_common_sv_packages -work signal_buffer_ctrl                            
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/limits_buffer.sv"                                                  -L altera_common_sv_packages -work signal_buffer_ctrl                            
