...
module soc_system_mm_interconnect_2 (
	...
	wire  [116:0] fifo_out_csr_agent_rf_source_data;                            // fifo_out_csr_agent:rf_source_data -> fifo_out_csr_agent_rsp_fifo:in_data
	...
	wire  [116:0] fifo_out_csr_agent_rsp_fifo_out_data;                         // fifo_out_csr_agent_rsp_fifo:out_data -> fifo_out_csr_agent:rf_sink_data
	...
	wire  [116:0] fifo_in_csr_agent_rf_source_data;                             // fifo_in_csr_agent:rf_source_data -> fifo_in_csr_agent_rsp_fifo:in_data
	...
	wire  [116:0] fifo_in_csr_agent_rsp_fifo_out_data;                          // fifo_in_csr_agent_rsp_fifo:out_data -> fifo_in_csr_agent:rf_sink_data
	...
	wire  [116:0] sgdma_st2mm_csr_agent_rf_source_data;                         // sgdma_st2mm_csr_agent:rf_source_data -> sgdma_st2mm_csr_agent_rsp_fifo:in_data
	...
	wire  [116:0] sgdma_st2mm_csr_agent_rsp_fifo_out_data;                      // sgdma_st2mm_csr_agent_rsp_fifo:out_data -> sgdma_st2mm_csr_agent:rf_sink_data
	...
	wire  [116:0] sgdma_mm2st_csr_agent_rf_source_data;                         // sgdma_mm2st_csr_agent:rf_source_data -> sgdma_mm2st_csr_agent_rsp_fifo:in_data
	...
	wire  [116:0] sgdma_mm2st_csr_agent_rsp_fifo_out_data;                      // sgdma_mm2st_csr_agent_rsp_fifo:out_data -> sgdma_mm2st_csr_agent:rf_sink_data
	...
	wire  [115:0] sysid_qsys_control_slave_agent_rp_data;                       // sysid_qsys_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [115:0] fifo_out_csr_agent_rp_data;                                   // fifo_out_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [115:0] fifo_in_csr_agent_rp_data;                                    // fifo_in_csr_agent:rp_data -> router_004:sink_data
	...
	wire  [115:0] sgdma_st2mm_csr_agent_rp_data;                                // sgdma_st2mm_csr_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] sgdma_mm2st_csr_agent_rp_data;                                // sgdma_mm2st_csr_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] led_pio_s1_agent_rp_data;                                     // led_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] dipsw_pio_s1_agent_rp_data;                                   // dipsw_pio_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [115:0] button_pio_s1_agent_rp_data;                                  // button_pio_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [115:0] cmd_mux_src_data;                                             // cmd_mux:src_data -> sysid_qsys_control_slave_burst_adapter:sink0_data
	...
	wire  [115:0] cmd_mux_001_src_data;                                         // cmd_mux_001:src_data -> fifo_out_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                        // fifo_out_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                      // cmd_mux_001:src_channel -> fifo_out_csr_burst_adapter:sink0_channel
	...
	wire  [115:0] fifo_out_csr_burst_adapter_source0_data;                      // fifo_out_csr_burst_adapter:source0_data -> fifo_out_csr_agent:cp_data
	wire          fifo_out_csr_burst_adapter_source0_ready;                     // fifo_out_csr_agent:cp_ready -> fifo_out_csr_burst_adapter:source0_ready
	wire    [7:0] fifo_out_csr_burst_adapter_source0_channel;                   // fifo_out_csr_burst_adapter:source0_channel -> fifo_out_csr_agent:cp_channel
	...
	wire  [115:0] cmd_mux_002_src_data;                                         // cmd_mux_002:src_data -> fifo_in_csr_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                        // fifo_in_csr_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                      // cmd_mux_002:src_channel -> fifo_in_csr_burst_adapter:sink0_channel
	...
	wire  [115:0] fifo_in_csr_burst_adapter_source0_data;                       // fifo_in_csr_burst_adapter:source0_data -> fifo_in_csr_agent:cp_data
	wire          fifo_in_csr_burst_adapter_source0_ready;                      // fifo_in_csr_agent:cp_ready -> fifo_in_csr_burst_adapter:source0_ready
	wire    [7:0] fifo_in_csr_burst_adapter_source0_channel;                    // fifo_in_csr_burst_adapter:source0_channel -> fifo_in_csr_agent:cp_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                         // cmd_mux_003:src_data -> sgdma_st2mm_csr_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                        // sgdma_st2mm_csr_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                      // cmd_mux_003:src_channel -> sgdma_st2mm_csr_burst_adapter:sink0_channel
	...
	wire  [115:0] sgdma_st2mm_csr_burst_adapter_source0_data;                   // sgdma_st2mm_csr_burst_adapter:source0_data -> sgdma_st2mm_csr_agent:cp_data
	...
	wire    [7:0] sgdma_st2mm_csr_burst_adapter_source0_channel;                // sgdma_st2mm_csr_burst_adapter:source0_channel -> sgdma_st2mm_csr_agent:cp_channel
	...
	wire  [115:0] cmd_mux_004_src_data;                                         // cmd_mux_004:src_data -> sgdma_mm2st_csr_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                        // sgdma_mm2st_csr_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                      // cmd_mux_004:src_channel -> sgdma_mm2st_csr_burst_adapter:sink0_channel
	...
	wire  [115:0] sgdma_mm2st_csr_burst_adapter_source0_data;                   // sgdma_mm2st_csr_burst_adapter:source0_data -> sgdma_mm2st_csr_agent:cp_data
	...
	wire    [7:0] sgdma_mm2st_csr_burst_adapter_source0_channel;                // sgdma_mm2st_csr_burst_adapter:source0_channel -> sgdma_mm2st_csr_agent:cp_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                         // cmd_mux_005:src_data -> led_pio_s1_burst_adapter:sink0_data
	...
	wire  [115:0] cmd_mux_006_src_data;                                         // cmd_mux_006:src_data -> dipsw_pio_s1_burst_adapter:sink0_data
	...
	wire  [115:0] cmd_mux_007_src_data;                                         // cmd_mux_007:src_data -> button_pio_s1_burst_adapter:sink0_data
