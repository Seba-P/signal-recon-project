...
module soc_system_mm_interconnect_3 (
		...
		output wire [3:0]  fifo2mm_csr_address,                                                 //                                                   fifo2mm_csr.address
		output wire        fifo2mm_csr_write,                                                   //                                                              .write
		output wire        fifo2mm_csr_read,                                                    //                                                              .read
		input  wire [31:0] fifo2mm_csr_readdata,                                                //                                                              .readdata
		output wire [31:0] fifo2mm_csr_writedata,                                               //                                                              .writedata
		output wire        fifo2mm_csr_chipselect,                                              //                                                              .chipselect
		output wire [9:0]  fir_in_RAM_s1_address,                                               //                                                 fir_in_RAM_s1.address
		output wire        fir_in_RAM_s1_write,                                                 //                                                              .write
		input  wire [63:0] fir_in_RAM_s1_readdata,                                              //                                                              .readdata
		output wire [63:0] fir_in_RAM_s1_writedata,                                             //                                                              .writedata
		output wire [7:0]  fir_in_RAM_s1_byteenable,                                            //                                                              .byteenable
		output wire        fir_in_RAM_s1_chipselect,                                            //                                                              .chipselect
		output wire        fir_in_RAM_s1_clken,                                                 //                                                              .clken
		output wire [9:0]  fir_out_RAM_s1_address,                                              //                                                fir_out_RAM_s1.address
		output wire        fir_out_RAM_s1_write,                                                //                                                              .write
		input  wire [63:0] fir_out_RAM_s1_readdata,                                             //                                                              .readdata
		output wire [63:0] fir_out_RAM_s1_writedata,                                            //                                                              .writedata
		output wire [7:0]  fir_out_RAM_s1_byteenable,                                           //                                                              .byteenable
		output wire        fir_out_RAM_s1_chipselect,                                           //                                                              .chipselect
		output wire        fir_out_RAM_s1_clken,                                                //                                                              .clken
		...
		output wire [3:0]  mm2fifo_csr_address,                                                 //                                                   mm2fifo_csr.address
		output wire        mm2fifo_csr_write,                                                   //                                                              .write
		output wire        mm2fifo_csr_read,                                                    //                                                              .read
		input  wire [31:0] mm2fifo_csr_readdata,                                                //                                                              .readdata
		output wire [31:0] mm2fifo_csr_writedata,                                               //                                                              .writedata
		output wire        mm2fifo_csr_chipselect,                                              //                                                              .chipselect
	...
	wire   [31:0] mm2fifo_csr_agent_m0_readdata;                                // mm2fifo_csr_translator:uav_readdata -> mm2fifo_csr_agent:m0_readdata
	wire          mm2fifo_csr_agent_m0_waitrequest;                             // mm2fifo_csr_translator:uav_waitrequest -> mm2fifo_csr_agent:m0_waitrequest
	wire          mm2fifo_csr_agent_m0_debugaccess;                             // mm2fifo_csr_agent:m0_debugaccess -> mm2fifo_csr_translator:uav_debugaccess
	wire   [20:0] mm2fifo_csr_agent_m0_address;                                 // mm2fifo_csr_agent:m0_address -> mm2fifo_csr_translator:uav_address
	wire    [3:0] mm2fifo_csr_agent_m0_byteenable;                              // mm2fifo_csr_agent:m0_byteenable -> mm2fifo_csr_translator:uav_byteenable
	wire          mm2fifo_csr_agent_m0_read;                                    // mm2fifo_csr_agent:m0_read -> mm2fifo_csr_translator:uav_read
	wire          mm2fifo_csr_agent_m0_readdatavalid;                           // mm2fifo_csr_translator:uav_readdatavalid -> mm2fifo_csr_agent:m0_readdatavalid
	wire          mm2fifo_csr_agent_m0_lock;                                    // mm2fifo_csr_agent:m0_lock -> mm2fifo_csr_translator:uav_lock
	wire   [31:0] mm2fifo_csr_agent_m0_writedata;                               // mm2fifo_csr_agent:m0_writedata -> mm2fifo_csr_translator:uav_writedata
	wire          mm2fifo_csr_agent_m0_write;                                   // mm2fifo_csr_agent:m0_write -> mm2fifo_csr_translator:uav_write
	wire    [2:0] mm2fifo_csr_agent_m0_burstcount;                              // mm2fifo_csr_agent:m0_burstcount -> mm2fifo_csr_translator:uav_burstcount
	wire          mm2fifo_csr_agent_rf_source_valid;                            // mm2fifo_csr_agent:rf_source_valid -> mm2fifo_csr_agent_rsp_fifo:in_valid
	wire  [117:0] mm2fifo_csr_agent_rf_source_data;                             // mm2fifo_csr_agent:rf_source_data -> mm2fifo_csr_agent_rsp_fifo:in_data
	wire          mm2fifo_csr_agent_rf_source_ready;                            // mm2fifo_csr_agent_rsp_fifo:in_ready -> mm2fifo_csr_agent:rf_source_ready
	wire          mm2fifo_csr_agent_rf_source_startofpacket;                    // mm2fifo_csr_agent:rf_source_startofpacket -> mm2fifo_csr_agent_rsp_fifo:in_startofpacket
	wire          mm2fifo_csr_agent_rf_source_endofpacket;                      // mm2fifo_csr_agent:rf_source_endofpacket -> mm2fifo_csr_agent_rsp_fifo:in_endofpacket
	wire          mm2fifo_csr_agent_rsp_fifo_out_valid;                         // mm2fifo_csr_agent_rsp_fifo:out_valid -> mm2fifo_csr_agent:rf_sink_valid
	wire  [117:0] mm2fifo_csr_agent_rsp_fifo_out_data;                          // mm2fifo_csr_agent_rsp_fifo:out_data -> mm2fifo_csr_agent:rf_sink_data
	wire          mm2fifo_csr_agent_rsp_fifo_out_ready;                         // mm2fifo_csr_agent:rf_sink_ready -> mm2fifo_csr_agent_rsp_fifo:out_ready
	wire          mm2fifo_csr_agent_rsp_fifo_out_startofpacket;                 // mm2fifo_csr_agent_rsp_fifo:out_startofpacket -> mm2fifo_csr_agent:rf_sink_startofpacket
	wire          mm2fifo_csr_agent_rsp_fifo_out_endofpacket;                   // mm2fifo_csr_agent_rsp_fifo:out_endofpacket -> mm2fifo_csr_agent:rf_sink_endofpacket
	wire          mm2fifo_csr_agent_rdata_fifo_src_valid;                       // mm2fifo_csr_agent:rdata_fifo_src_valid -> mm2fifo_csr_agent_rdata_fifo:in_valid
	wire   [33:0] mm2fifo_csr_agent_rdata_fifo_src_data;                        // mm2fifo_csr_agent:rdata_fifo_src_data -> mm2fifo_csr_agent_rdata_fifo:in_data
	wire          mm2fifo_csr_agent_rdata_fifo_src_ready;                       // mm2fifo_csr_agent_rdata_fifo:in_ready -> mm2fifo_csr_agent:rdata_fifo_src_ready
	wire   [31:0] fifo2mm_csr_agent_m0_readdata;                                // fifo2mm_csr_translator:uav_readdata -> fifo2mm_csr_agent:m0_readdata
	wire          fifo2mm_csr_agent_m0_waitrequest;                             // fifo2mm_csr_translator:uav_waitrequest -> fifo2mm_csr_agent:m0_waitrequest
	wire          fifo2mm_csr_agent_m0_debugaccess;                             // fifo2mm_csr_agent:m0_debugaccess -> fifo2mm_csr_translator:uav_debugaccess
	wire   [20:0] fifo2mm_csr_agent_m0_address;                                 // fifo2mm_csr_agent:m0_address -> fifo2mm_csr_translator:uav_address
	wire    [3:0] fifo2mm_csr_agent_m0_byteenable;                              // fifo2mm_csr_agent:m0_byteenable -> fifo2mm_csr_translator:uav_byteenable
	wire          fifo2mm_csr_agent_m0_read;                                    // fifo2mm_csr_agent:m0_read -> fifo2mm_csr_translator:uav_read
	wire          fifo2mm_csr_agent_m0_readdatavalid;                           // fifo2mm_csr_translator:uav_readdatavalid -> fifo2mm_csr_agent:m0_readdatavalid
	wire          fifo2mm_csr_agent_m0_lock;                                    // fifo2mm_csr_agent:m0_lock -> fifo2mm_csr_translator:uav_lock
	wire   [31:0] fifo2mm_csr_agent_m0_writedata;                               // fifo2mm_csr_agent:m0_writedata -> fifo2mm_csr_translator:uav_writedata
	wire          fifo2mm_csr_agent_m0_write;                                   // fifo2mm_csr_agent:m0_write -> fifo2mm_csr_translator:uav_write
	wire    [2:0] fifo2mm_csr_agent_m0_burstcount;                              // fifo2mm_csr_agent:m0_burstcount -> fifo2mm_csr_translator:uav_burstcount
	wire          fifo2mm_csr_agent_rf_source_valid;                            // fifo2mm_csr_agent:rf_source_valid -> fifo2mm_csr_agent_rsp_fifo:in_valid
	wire  [117:0] fifo2mm_csr_agent_rf_source_data;                             // fifo2mm_csr_agent:rf_source_data -> fifo2mm_csr_agent_rsp_fifo:in_data
	wire          fifo2mm_csr_agent_rf_source_ready;                            // fifo2mm_csr_agent_rsp_fifo:in_ready -> fifo2mm_csr_agent:rf_source_ready
	wire          fifo2mm_csr_agent_rf_source_startofpacket;                    // fifo2mm_csr_agent:rf_source_startofpacket -> fifo2mm_csr_agent_rsp_fifo:in_startofpacket
	wire          fifo2mm_csr_agent_rf_source_endofpacket;                      // fifo2mm_csr_agent:rf_source_endofpacket -> fifo2mm_csr_agent_rsp_fifo:in_endofpacket
	wire          fifo2mm_csr_agent_rsp_fifo_out_valid;                         // fifo2mm_csr_agent_rsp_fifo:out_valid -> fifo2mm_csr_agent:rf_sink_valid
	wire  [117:0] fifo2mm_csr_agent_rsp_fifo_out_data;                          // fifo2mm_csr_agent_rsp_fifo:out_data -> fifo2mm_csr_agent:rf_sink_data
	wire          fifo2mm_csr_agent_rsp_fifo_out_ready;                         // fifo2mm_csr_agent:rf_sink_ready -> fifo2mm_csr_agent_rsp_fifo:out_ready
	wire          fifo2mm_csr_agent_rsp_fifo_out_startofpacket;                 // fifo2mm_csr_agent_rsp_fifo:out_startofpacket -> fifo2mm_csr_agent:rf_sink_startofpacket
	wire          fifo2mm_csr_agent_rsp_fifo_out_endofpacket;                   // fifo2mm_csr_agent_rsp_fifo:out_endofpacket -> fifo2mm_csr_agent:rf_sink_endofpacket
	wire          fifo2mm_csr_agent_rdata_fifo_src_valid;                       // fifo2mm_csr_agent:rdata_fifo_src_valid -> fifo2mm_csr_agent_rdata_fifo:in_valid
	wire   [33:0] fifo2mm_csr_agent_rdata_fifo_src_data;                        // fifo2mm_csr_agent:rdata_fifo_src_data -> fifo2mm_csr_agent_rdata_fifo:in_data
	wire          fifo2mm_csr_agent_rdata_fifo_src_ready;                       // fifo2mm_csr_agent_rdata_fifo:in_ready -> fifo2mm_csr_agent:rdata_fifo_src_ready
	...
	wire  [117:0] led_pio_s1_agent_rf_source_data;                              // led_pio_s1_agent:rf_source_data -> led_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [117:0] led_pio_s1_agent_rsp_fifo_out_data;                           // led_pio_s1_agent_rsp_fifo:out_data -> led_pio_s1_agent:rf_sink_data
	...
	wire  [117:0] dipsw_pio_s1_agent_rf_source_data;                            // dipsw_pio_s1_agent:rf_source_data -> dipsw_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [117:0] dipsw_pio_s1_agent_rsp_fifo_out_data;                         // dipsw_pio_s1_agent_rsp_fifo:out_data -> dipsw_pio_s1_agent:rf_sink_data
	...
	wire  [117:0] button_pio_s1_agent_rf_source_data;                           // button_pio_s1_agent:rf_source_data -> button_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [117:0] button_pio_s1_agent_rsp_fifo_out_data;                        // button_pio_s1_agent_rsp_fifo:out_data -> button_pio_s1_agent:rf_sink_data
	...
	wire   [63:0] fir_out_ram_s1_agent_m0_readdata;                             // fir_out_RAM_s1_translator:uav_readdata -> fir_out_RAM_s1_agent:m0_readdata
	wire          fir_out_ram_s1_agent_m0_waitrequest;                          // fir_out_RAM_s1_translator:uav_waitrequest -> fir_out_RAM_s1_agent:m0_waitrequest
	wire          fir_out_ram_s1_agent_m0_debugaccess;                          // fir_out_RAM_s1_agent:m0_debugaccess -> fir_out_RAM_s1_translator:uav_debugaccess
	wire   [20:0] fir_out_ram_s1_agent_m0_address;                              // fir_out_RAM_s1_agent:m0_address -> fir_out_RAM_s1_translator:uav_address
	wire    [7:0] fir_out_ram_s1_agent_m0_byteenable;                           // fir_out_RAM_s1_agent:m0_byteenable -> fir_out_RAM_s1_translator:uav_byteenable
	wire          fir_out_ram_s1_agent_m0_read;                                 // fir_out_RAM_s1_agent:m0_read -> fir_out_RAM_s1_translator:uav_read
	wire          fir_out_ram_s1_agent_m0_readdatavalid;                        // fir_out_RAM_s1_translator:uav_readdatavalid -> fir_out_RAM_s1_agent:m0_readdatavalid
	wire          fir_out_ram_s1_agent_m0_lock;                                 // fir_out_RAM_s1_agent:m0_lock -> fir_out_RAM_s1_translator:uav_lock
	wire   [63:0] fir_out_ram_s1_agent_m0_writedata;                            // fir_out_RAM_s1_agent:m0_writedata -> fir_out_RAM_s1_translator:uav_writedata
	wire          fir_out_ram_s1_agent_m0_write;                                // fir_out_RAM_s1_agent:m0_write -> fir_out_RAM_s1_translator:uav_write
	wire    [3:0] fir_out_ram_s1_agent_m0_burstcount;                           // fir_out_RAM_s1_agent:m0_burstcount -> fir_out_RAM_s1_translator:uav_burstcount
	wire          fir_out_ram_s1_agent_rf_source_valid;                         // fir_out_RAM_s1_agent:rf_source_valid -> fir_out_RAM_s1_agent_rsp_fifo:in_valid
	wire  [153:0] fir_out_ram_s1_agent_rf_source_data;                          // fir_out_RAM_s1_agent:rf_source_data -> fir_out_RAM_s1_agent_rsp_fifo:in_data
	wire          fir_out_ram_s1_agent_rf_source_ready;                         // fir_out_RAM_s1_agent_rsp_fifo:in_ready -> fir_out_RAM_s1_agent:rf_source_ready
	wire          fir_out_ram_s1_agent_rf_source_startofpacket;                 // fir_out_RAM_s1_agent:rf_source_startofpacket -> fir_out_RAM_s1_agent_rsp_fifo:in_startofpacket
	wire          fir_out_ram_s1_agent_rf_source_endofpacket;                   // fir_out_RAM_s1_agent:rf_source_endofpacket -> fir_out_RAM_s1_agent_rsp_fifo:in_endofpacket
	wire          fir_out_ram_s1_agent_rsp_fifo_out_valid;                      // fir_out_RAM_s1_agent_rsp_fifo:out_valid -> fir_out_RAM_s1_agent:rf_sink_valid
	wire  [153:0] fir_out_ram_s1_agent_rsp_fifo_out_data;                       // fir_out_RAM_s1_agent_rsp_fifo:out_data -> fir_out_RAM_s1_agent:rf_sink_data
	wire          fir_out_ram_s1_agent_rsp_fifo_out_ready;                      // fir_out_RAM_s1_agent:rf_sink_ready -> fir_out_RAM_s1_agent_rsp_fifo:out_ready
	wire          fir_out_ram_s1_agent_rsp_fifo_out_startofpacket;              // fir_out_RAM_s1_agent_rsp_fifo:out_startofpacket -> fir_out_RAM_s1_agent:rf_sink_startofpacket
	wire          fir_out_ram_s1_agent_rsp_fifo_out_endofpacket;                // fir_out_RAM_s1_agent_rsp_fifo:out_endofpacket -> fir_out_RAM_s1_agent:rf_sink_endofpacket
	wire          fir_out_ram_s1_agent_rdata_fifo_src_valid;                    // fir_out_RAM_s1_agent:rdata_fifo_src_valid -> fir_out_RAM_s1_agent_rdata_fifo:in_valid
	wire   [65:0] fir_out_ram_s1_agent_rdata_fifo_src_data;                     // fir_out_RAM_s1_agent:rdata_fifo_src_data -> fir_out_RAM_s1_agent_rdata_fifo:in_data
	wire          fir_out_ram_s1_agent_rdata_fifo_src_ready;                    // fir_out_RAM_s1_agent_rdata_fifo:in_ready -> fir_out_RAM_s1_agent:rdata_fifo_src_ready
	wire   [63:0] fir_in_ram_s1_agent_m0_readdata;                              // fir_in_RAM_s1_translator:uav_readdata -> fir_in_RAM_s1_agent:m0_readdata
	wire          fir_in_ram_s1_agent_m0_waitrequest;                           // fir_in_RAM_s1_translator:uav_waitrequest -> fir_in_RAM_s1_agent:m0_waitrequest
	wire          fir_in_ram_s1_agent_m0_debugaccess;                           // fir_in_RAM_s1_agent:m0_debugaccess -> fir_in_RAM_s1_translator:uav_debugaccess
	wire   [20:0] fir_in_ram_s1_agent_m0_address;                               // fir_in_RAM_s1_agent:m0_address -> fir_in_RAM_s1_translator:uav_address
	wire    [7:0] fir_in_ram_s1_agent_m0_byteenable;                            // fir_in_RAM_s1_agent:m0_byteenable -> fir_in_RAM_s1_translator:uav_byteenable
	wire          fir_in_ram_s1_agent_m0_read;                                  // fir_in_RAM_s1_agent:m0_read -> fir_in_RAM_s1_translator:uav_read
	wire          fir_in_ram_s1_agent_m0_readdatavalid;                         // fir_in_RAM_s1_translator:uav_readdatavalid -> fir_in_RAM_s1_agent:m0_readdatavalid
	wire          fir_in_ram_s1_agent_m0_lock;                                  // fir_in_RAM_s1_agent:m0_lock -> fir_in_RAM_s1_translator:uav_lock
	wire   [63:0] fir_in_ram_s1_agent_m0_writedata;                             // fir_in_RAM_s1_agent:m0_writedata -> fir_in_RAM_s1_translator:uav_writedata
	wire          fir_in_ram_s1_agent_m0_write;                                 // fir_in_RAM_s1_agent:m0_write -> fir_in_RAM_s1_translator:uav_write
	wire    [3:0] fir_in_ram_s1_agent_m0_burstcount;                            // fir_in_RAM_s1_agent:m0_burstcount -> fir_in_RAM_s1_translator:uav_burstcount
	wire          fir_in_ram_s1_agent_rf_source_valid;                          // fir_in_RAM_s1_agent:rf_source_valid -> fir_in_RAM_s1_agent_rsp_fifo:in_valid
	wire  [153:0] fir_in_ram_s1_agent_rf_source_data;                           // fir_in_RAM_s1_agent:rf_source_data -> fir_in_RAM_s1_agent_rsp_fifo:in_data
	wire          fir_in_ram_s1_agent_rf_source_ready;                          // fir_in_RAM_s1_agent_rsp_fifo:in_ready -> fir_in_RAM_s1_agent:rf_source_ready
	wire          fir_in_ram_s1_agent_rf_source_startofpacket;                  // fir_in_RAM_s1_agent:rf_source_startofpacket -> fir_in_RAM_s1_agent_rsp_fifo:in_startofpacket
	wire          fir_in_ram_s1_agent_rf_source_endofpacket;                    // fir_in_RAM_s1_agent:rf_source_endofpacket -> fir_in_RAM_s1_agent_rsp_fifo:in_endofpacket
	wire          fir_in_ram_s1_agent_rsp_fifo_out_valid;                       // fir_in_RAM_s1_agent_rsp_fifo:out_valid -> fir_in_RAM_s1_agent:rf_sink_valid
	wire  [153:0] fir_in_ram_s1_agent_rsp_fifo_out_data;                        // fir_in_RAM_s1_agent_rsp_fifo:out_data -> fir_in_RAM_s1_agent:rf_sink_data
	wire          fir_in_ram_s1_agent_rsp_fifo_out_ready;                       // fir_in_RAM_s1_agent:rf_sink_ready -> fir_in_RAM_s1_agent_rsp_fifo:out_ready
	wire          fir_in_ram_s1_agent_rsp_fifo_out_startofpacket;               // fir_in_RAM_s1_agent_rsp_fifo:out_startofpacket -> fir_in_RAM_s1_agent:rf_sink_startofpacket
	wire          fir_in_ram_s1_agent_rsp_fifo_out_endofpacket;                 // fir_in_RAM_s1_agent_rsp_fifo:out_endofpacket -> fir_in_RAM_s1_agent:rf_sink_endofpacket
	wire          fir_in_ram_s1_agent_rdata_fifo_src_valid;                     // fir_in_RAM_s1_agent:rdata_fifo_src_valid -> fir_in_RAM_s1_agent_rdata_fifo:in_valid
	wire   [65:0] fir_in_ram_s1_agent_rdata_fifo_src_data;                      // fir_in_RAM_s1_agent:rdata_fifo_src_data -> fir_in_RAM_s1_agent_rdata_fifo:in_data
	wire          fir_in_ram_s1_agent_rdata_fifo_src_ready;                     // fir_in_RAM_s1_agent_rdata_fifo:in_ready -> fir_in_RAM_s1_agent:rdata_fifo_src_ready
	wire          hps_0_h2f_lw_axi_master_agent_write_cp_valid;                 // hps_0_h2f_lw_axi_master_agent:write_cp_valid -> router:sink_valid
	wire  [116:0] hps_0_h2f_lw_axi_master_agent_write_cp_data;                  // hps_0_h2f_lw_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [116:0] hps_0_h2f_lw_axi_master_agent_read_cp_data;                   // hps_0_h2f_lw_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [116:0] sysid_qsys_control_slave_agent_rp_data;                       // sysid_qsys_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [116:0] router_002_src_data;                                          // router_002:src_data -> rsp_demux:sink_data
	...
	wire          mm2fifo_csr_agent_rp_valid;                                   // mm2fifo_csr_agent:rp_valid -> router_003:sink_valid
	wire  [116:0] mm2fifo_csr_agent_rp_data;                                    // mm2fifo_csr_agent:rp_data -> router_003:sink_data
	wire          mm2fifo_csr_agent_rp_ready;                                   // router_003:sink_ready -> mm2fifo_csr_agent:rp_ready
	wire          mm2fifo_csr_agent_rp_startofpacket;                           // mm2fifo_csr_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          mm2fifo_csr_agent_rp_endofpacket;                             // mm2fifo_csr_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          fifo2mm_csr_agent_rp_valid;                                   // fifo2mm_csr_agent:rp_valid -> router_004:sink_valid
	wire  [116:0] fifo2mm_csr_agent_rp_data;                                    // fifo2mm_csr_agent:rp_data -> router_004:sink_data
	wire          fifo2mm_csr_agent_rp_ready;                                   // router_004:sink_ready -> fifo2mm_csr_agent:rp_ready
	wire          fifo2mm_csr_agent_rp_startofpacket;                           // fifo2mm_csr_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          fifo2mm_csr_agent_rp_endofpacket;                             // fifo2mm_csr_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [116:0] led_pio_s1_agent_rp_data;                                     // led_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [116:0] dipsw_pio_s1_agent_rp_data;                                   // dipsw_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [116:0] button_pio_s1_agent_rp_data;                                  // button_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [116:0] router_007_src_data;                                          // router_007:src_data -> rsp_demux_005:sink_data
	...
	wire          fir_out_ram_s1_agent_rp_valid;                                // fir_out_RAM_s1_agent:rp_valid -> router_008:sink_valid
	wire  [152:0] fir_out_ram_s1_agent_rp_data;                                 // fir_out_RAM_s1_agent:rp_data -> router_008:sink_data
	wire          fir_out_ram_s1_agent_rp_ready;                                // router_008:sink_ready -> fir_out_RAM_s1_agent:rp_ready
	wire          fir_out_ram_s1_agent_rp_startofpacket;                        // fir_out_RAM_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          fir_out_ram_s1_agent_rp_endofpacket;                          // fir_out_RAM_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	wire          fir_in_ram_s1_agent_rp_valid;                                 // fir_in_RAM_s1_agent:rp_valid -> router_009:sink_valid
	wire  [152:0] fir_in_ram_s1_agent_rp_data;                                  // fir_in_RAM_s1_agent:rp_data -> router_009:sink_data
	wire          fir_in_ram_s1_agent_rp_ready;                                 // router_009:sink_ready -> fir_in_RAM_s1_agent:rp_ready
	wire          fir_in_ram_s1_agent_rp_startofpacket;                         // fir_in_RAM_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          fir_in_ram_s1_agent_rp_endofpacket;                           // fir_in_RAM_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	wire          router_src_valid;                                             // router:src_valid -> hps_0_h2f_lw_axi_master_wr_limiter:cmd_sink_valid
	wire  [116:0] router_src_data;                                              // router:src_data -> hps_0_h2f_lw_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [116:0] hps_0_h2f_lw_axi_master_wr_limiter_cmd_src_data;              // hps_0_h2f_lw_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [116:0] rsp_mux_src_data;                                             // rsp_mux:src_data -> hps_0_h2f_lw_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [116:0] hps_0_h2f_lw_axi_master_wr_limiter_rsp_src_data;              // hps_0_h2f_lw_axi_master_wr_limiter:rsp_src_data -> hps_0_h2f_lw_axi_master_agent:write_rp_data
	...
	wire  [116:0] router_001_src_data;                                          // router_001:src_data -> hps_0_h2f_lw_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [116:0] hps_0_h2f_lw_axi_master_rd_limiter_cmd_src_data;              // hps_0_h2f_lw_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [116:0] rsp_mux_001_src_data;                                         // rsp_mux_001:src_data -> hps_0_h2f_lw_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [116:0] hps_0_h2f_lw_axi_master_rd_limiter_rsp_src_data;              // hps_0_h2f_lw_axi_master_rd_limiter:rsp_src_data -> hps_0_h2f_lw_axi_master_agent:read_rp_data
	...
	wire  [116:0] cmd_mux_src_data;                                             // cmd_mux:src_data -> sysid_qsys_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                            // sysid_qsys_control_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [7:0] cmd_mux_src_channel;                                          // cmd_mux:src_channel -> sysid_qsys_control_slave_burst_adapter:sink0_channel
	...
	wire  [116:0] sysid_qsys_control_slave_burst_adapter_source0_data;          // sysid_qsys_control_slave_burst_adapter:source0_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire          cmd_mux_001_src_valid;                                        // cmd_mux_001:src_valid -> mm2fifo_csr_burst_adapter:sink0_valid
	wire  [116:0] cmd_mux_001_src_data;                                         // cmd_mux_001:src_data -> mm2fifo_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                        // mm2fifo_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                      // cmd_mux_001:src_channel -> mm2fifo_csr_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                // cmd_mux_001:src_startofpacket -> mm2fifo_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                  // cmd_mux_001:src_endofpacket -> mm2fifo_csr_burst_adapter:sink0_endofpacket
	wire          mm2fifo_csr_burst_adapter_source0_valid;                      // mm2fifo_csr_burst_adapter:source0_valid -> mm2fifo_csr_agent:cp_valid
	wire  [116:0] mm2fifo_csr_burst_adapter_source0_data;                       // mm2fifo_csr_burst_adapter:source0_data -> mm2fifo_csr_agent:cp_data
	wire          mm2fifo_csr_burst_adapter_source0_ready;                      // mm2fifo_csr_agent:cp_ready -> mm2fifo_csr_burst_adapter:source0_ready
	wire    [7:0] mm2fifo_csr_burst_adapter_source0_channel;                    // mm2fifo_csr_burst_adapter:source0_channel -> mm2fifo_csr_agent:cp_channel
	wire          mm2fifo_csr_burst_adapter_source0_startofpacket;              // mm2fifo_csr_burst_adapter:source0_startofpacket -> mm2fifo_csr_agent:cp_startofpacket
	wire          mm2fifo_csr_burst_adapter_source0_endofpacket;                // mm2fifo_csr_burst_adapter:source0_endofpacket -> mm2fifo_csr_agent:cp_endofpacket
	wire          cmd_mux_002_src_valid;                                        // cmd_mux_002:src_valid -> fifo2mm_csr_burst_adapter:sink0_valid
	wire  [116:0] cmd_mux_002_src_data;                                         // cmd_mux_002:src_data -> fifo2mm_csr_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                        // fifo2mm_csr_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                      // cmd_mux_002:src_channel -> fifo2mm_csr_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                // cmd_mux_002:src_startofpacket -> fifo2mm_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                  // cmd_mux_002:src_endofpacket -> fifo2mm_csr_burst_adapter:sink0_endofpacket
	wire          fifo2mm_csr_burst_adapter_source0_valid;                      // fifo2mm_csr_burst_adapter:source0_valid -> fifo2mm_csr_agent:cp_valid
	wire  [116:0] fifo2mm_csr_burst_adapter_source0_data;                       // fifo2mm_csr_burst_adapter:source0_data -> fifo2mm_csr_agent:cp_data
	wire          fifo2mm_csr_burst_adapter_source0_ready;                      // fifo2mm_csr_agent:cp_ready -> fifo2mm_csr_burst_adapter:source0_ready
	wire    [7:0] fifo2mm_csr_burst_adapter_source0_channel;                    // fifo2mm_csr_burst_adapter:source0_channel -> fifo2mm_csr_agent:cp_channel
	wire          fifo2mm_csr_burst_adapter_source0_startofpacket;              // fifo2mm_csr_burst_adapter:source0_startofpacket -> fifo2mm_csr_agent:cp_startofpacket
	wire          fifo2mm_csr_burst_adapter_source0_endofpacket;                // fifo2mm_csr_burst_adapter:source0_endofpacket -> fifo2mm_csr_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                        // cmd_mux_003:src_valid -> led_pio_s1_burst_adapter:sink0_valid
	wire  [116:0] cmd_mux_003_src_data;                                         // cmd_mux_003:src_data -> led_pio_s1_burst_adapter:sink0_data
	...
	wire  [116:0] led_pio_s1_burst_adapter_source0_data;                        // led_pio_s1_burst_adapter:source0_data -> led_pio_s1_agent:cp_data
	...
	wire  [116:0] cmd_mux_004_src_data;                                         // cmd_mux_004:src_data -> dipsw_pio_s1_burst_adapter:sink0_data
	...
	wire  [116:0] dipsw_pio_s1_burst_adapter_source0_data;                      // dipsw_pio_s1_burst_adapter:source0_data -> dipsw_pio_s1_agent:cp_data
	...
	wire  [116:0] cmd_mux_005_src_data;                                         // cmd_mux_005:src_data -> button_pio_s1_burst_adapter:sink0_data
	...
	wire  [116:0] button_pio_s1_burst_adapter_source0_data;                     // button_pio_s1_burst_adapter:source0_data -> button_pio_s1_agent:cp_data
	...
	wire          fir_out_ram_s1_burst_adapter_source0_valid;                   // fir_out_RAM_s1_burst_adapter:source0_valid -> fir_out_RAM_s1_agent:cp_valid
	wire  [152:0] fir_out_ram_s1_burst_adapter_source0_data;                    // fir_out_RAM_s1_burst_adapter:source0_data -> fir_out_RAM_s1_agent:cp_data
	wire          fir_out_ram_s1_burst_adapter_source0_ready;                   // fir_out_RAM_s1_agent:cp_ready -> fir_out_RAM_s1_burst_adapter:source0_ready
	wire    [7:0] fir_out_ram_s1_burst_adapter_source0_channel;                 // fir_out_RAM_s1_burst_adapter:source0_channel -> fir_out_RAM_s1_agent:cp_channel
	wire          fir_out_ram_s1_burst_adapter_source0_startofpacket;           // fir_out_RAM_s1_burst_adapter:source0_startofpacket -> fir_out_RAM_s1_agent:cp_startofpacket
	wire          fir_out_ram_s1_burst_adapter_source0_endofpacket;             // fir_out_RAM_s1_burst_adapter:source0_endofpacket -> fir_out_RAM_s1_agent:cp_endofpacket
	wire          fir_in_ram_s1_burst_adapter_source0_valid;                    // fir_in_RAM_s1_burst_adapter:source0_valid -> fir_in_RAM_s1_agent:cp_valid
	wire  [152:0] fir_in_ram_s1_burst_adapter_source0_data;                     // fir_in_RAM_s1_burst_adapter:source0_data -> fir_in_RAM_s1_agent:cp_data
	wire          fir_in_ram_s1_burst_adapter_source0_ready;                    // fir_in_RAM_s1_agent:cp_ready -> fir_in_RAM_s1_burst_adapter:source0_ready
	wire    [7:0] fir_in_ram_s1_burst_adapter_source0_channel;                  // fir_in_RAM_s1_burst_adapter:source0_channel -> fir_in_RAM_s1_agent:cp_channel
	wire          fir_in_ram_s1_burst_adapter_source0_startofpacket;            // fir_in_RAM_s1_burst_adapter:source0_startofpacket -> fir_in_RAM_s1_agent:cp_startofpacket
	wire          fir_in_ram_s1_burst_adapter_source0_endofpacket;              // fir_in_RAM_s1_burst_adapter:source0_endofpacket -> fir_in_RAM_s1_agent:cp_endofpacket
	...
	wire  [116:0] cmd_demux_001_src4_data;                                      // cmd_demux_001:src4_data -> cmd_mux_004:sink1_data
	...
	wire  [116:0] cmd_demux_001_src5_data;                                      // cmd_demux_001:src5_data -> cmd_mux_005:sink1_data
	...
	wire  [116:0] cmd_demux_001_src6_data;                                      // cmd_demux_001:src6_data -> cmd_mux_006:sink1_data
	...
	wire  [116:0] cmd_demux_001_src7_data;                                      // cmd_demux_001:src7_data -> cmd_mux_007:sink1_data
	...
	wire  [116:0] rsp_demux_004_src1_data;                                      // rsp_demux_004:src1_data -> rsp_mux_001:sink4_data
	...
	wire  [116:0] rsp_demux_005_src1_data;                                      // rsp_demux_005:src1_data -> rsp_mux_001:sink5_data
	...
	wire  [116:0] rsp_demux_006_src1_data;                                      // rsp_demux_006:src1_data -> rsp_mux_001:sink6_data
	...
	wire  [116:0] rsp_demux_007_src1_data;                                      // rsp_demux_007:src1_data -> rsp_mux_001:sink7_data
	...
	wire          router_008_src_valid;                                         // router_008:src_valid -> fir_out_RAM_s1_rsp_width_adapter:in_valid
	wire  [152:0] router_008_src_data;                                          // router_008:src_data -> fir_out_RAM_s1_rsp_width_adapter:in_data
	wire          router_008_src_ready;                                         // fir_out_RAM_s1_rsp_width_adapter:in_ready -> router_008:src_ready
	wire    [7:0] router_008_src_channel;                                       // router_008:src_channel -> fir_out_RAM_s1_rsp_width_adapter:in_channel
	wire          router_008_src_startofpacket;                                 // router_008:src_startofpacket -> fir_out_RAM_s1_rsp_width_adapter:in_startofpacket
	wire          router_008_src_endofpacket;                                   // router_008:src_endofpacket -> fir_out_RAM_s1_rsp_width_adapter:in_endofpacket
	wire          fir_out_ram_s1_rsp_width_adapter_src_valid;                   // fir_out_RAM_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [116:0] fir_out_ram_s1_rsp_width_adapter_src_data;                    // fir_out_RAM_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          fir_out_ram_s1_rsp_width_adapter_src_ready;                   // rsp_demux_006:sink_ready -> fir_out_RAM_s1_rsp_width_adapter:out_ready
	wire    [7:0] fir_out_ram_s1_rsp_width_adapter_src_channel;                 // fir_out_RAM_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          fir_out_ram_s1_rsp_width_adapter_src_startofpacket;           // fir_out_RAM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          fir_out_ram_s1_rsp_width_adapter_src_endofpacket;             // fir_out_RAM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	wire          router_009_src_valid;                                         // router_009:src_valid -> fir_in_RAM_s1_rsp_width_adapter:in_valid
	wire  [152:0] router_009_src_data;                                          // router_009:src_data -> fir_in_RAM_s1_rsp_width_adapter:in_data
	wire          router_009_src_ready;                                         // fir_in_RAM_s1_rsp_width_adapter:in_ready -> router_009:src_ready
	wire    [7:0] router_009_src_channel;                                       // router_009:src_channel -> fir_in_RAM_s1_rsp_width_adapter:in_channel
	wire          router_009_src_startofpacket;                                 // router_009:src_startofpacket -> fir_in_RAM_s1_rsp_width_adapter:in_startofpacket
	wire          router_009_src_endofpacket;                                   // router_009:src_endofpacket -> fir_in_RAM_s1_rsp_width_adapter:in_endofpacket
	wire          fir_in_ram_s1_rsp_width_adapter_src_valid;                    // fir_in_RAM_s1_rsp_width_adapter:out_valid -> rsp_demux_007:sink_valid
	wire  [116:0] fir_in_ram_s1_rsp_width_adapter_src_data;                     // fir_in_RAM_s1_rsp_width_adapter:out_data -> rsp_demux_007:sink_data
	wire          fir_in_ram_s1_rsp_width_adapter_src_ready;                    // rsp_demux_007:sink_ready -> fir_in_RAM_s1_rsp_width_adapter:out_ready
	wire    [7:0] fir_in_ram_s1_rsp_width_adapter_src_channel;                  // fir_in_RAM_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	wire          fir_in_ram_s1_rsp_width_adapter_src_startofpacket;            // fir_in_RAM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_007:sink_startofpacket
	wire          fir_in_ram_s1_rsp_width_adapter_src_endofpacket;              // fir_in_RAM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_007:sink_endofpacket
	wire          cmd_mux_006_src_valid;                                        // cmd_mux_006:src_valid -> fir_out_RAM_s1_cmd_width_adapter:in_valid
	wire  [116:0] cmd_mux_006_src_data;                                         // cmd_mux_006:src_data -> fir_out_RAM_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                        // fir_out_RAM_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                      // cmd_mux_006:src_channel -> fir_out_RAM_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                // cmd_mux_006:src_startofpacket -> fir_out_RAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                  // cmd_mux_006:src_endofpacket -> fir_out_RAM_s1_cmd_width_adapter:in_endofpacket
	wire          fir_out_ram_s1_cmd_width_adapter_src_valid;                   // fir_out_RAM_s1_cmd_width_adapter:out_valid -> fir_out_RAM_s1_burst_adapter:sink0_valid
	wire  [152:0] fir_out_ram_s1_cmd_width_adapter_src_data;                    // fir_out_RAM_s1_cmd_width_adapter:out_data -> fir_out_RAM_s1_burst_adapter:sink0_data
	wire          fir_out_ram_s1_cmd_width_adapter_src_ready;                   // fir_out_RAM_s1_burst_adapter:sink0_ready -> fir_out_RAM_s1_cmd_width_adapter:out_ready
	wire    [7:0] fir_out_ram_s1_cmd_width_adapter_src_channel;                 // fir_out_RAM_s1_cmd_width_adapter:out_channel -> fir_out_RAM_s1_burst_adapter:sink0_channel
	wire          fir_out_ram_s1_cmd_width_adapter_src_startofpacket;           // fir_out_RAM_s1_cmd_width_adapter:out_startofpacket -> fir_out_RAM_s1_burst_adapter:sink0_startofpacket
	wire          fir_out_ram_s1_cmd_width_adapter_src_endofpacket;             // fir_out_RAM_s1_cmd_width_adapter:out_endofpacket -> fir_out_RAM_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_007_src_valid;                                        // cmd_mux_007:src_valid -> fir_in_RAM_s1_cmd_width_adapter:in_valid
	wire  [116:0] cmd_mux_007_src_data;                                         // cmd_mux_007:src_data -> fir_in_RAM_s1_cmd_width_adapter:in_data
	wire          cmd_mux_007_src_ready;                                        // fir_in_RAM_s1_cmd_width_adapter:in_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                      // cmd_mux_007:src_channel -> fir_in_RAM_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_007_src_startofpacket;                                // cmd_mux_007:src_startofpacket -> fir_in_RAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                  // cmd_mux_007:src_endofpacket -> fir_in_RAM_s1_cmd_width_adapter:in_endofpacket
	wire          fir_in_ram_s1_cmd_width_adapter_src_valid;                    // fir_in_RAM_s1_cmd_width_adapter:out_valid -> fir_in_RAM_s1_burst_adapter:sink0_valid
	wire  [152:0] fir_in_ram_s1_cmd_width_adapter_src_data;                     // fir_in_RAM_s1_cmd_width_adapter:out_data -> fir_in_RAM_s1_burst_adapter:sink0_data
	wire          fir_in_ram_s1_cmd_width_adapter_src_ready;                    // fir_in_RAM_s1_burst_adapter:sink0_ready -> fir_in_RAM_s1_cmd_width_adapter:out_ready
	wire    [7:0] fir_in_ram_s1_cmd_width_adapter_src_channel;                  // fir_in_RAM_s1_cmd_width_adapter:out_channel -> fir_in_RAM_s1_burst_adapter:sink0_channel
	wire          fir_in_ram_s1_cmd_width_adapter_src_startofpacket;            // fir_in_RAM_s1_cmd_width_adapter:out_startofpacket -> fir_in_RAM_s1_burst_adapter:sink0_startofpacket
	wire          fir_in_ram_s1_cmd_width_adapter_src_endofpacket;              // fir_in_RAM_s1_cmd_width_adapter:out_endofpacket -> fir_in_RAM_s1_burst_adapter:sink0_endofpacket
	...
	wire          mm2fifo_csr_agent_rdata_fifo_out_valid;                       // mm2fifo_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] mm2fifo_csr_agent_rdata_fifo_out_data;                        // mm2fifo_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          mm2fifo_csr_agent_rdata_fifo_out_ready;                       // avalon_st_adapter_001:in_0_ready -> mm2fifo_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                            // avalon_st_adapter_001:out_0_valid -> mm2fifo_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                             // avalon_st_adapter_001:out_0_data -> mm2fifo_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                            // mm2fifo_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                            // avalon_st_adapter_001:out_0_error -> mm2fifo_csr_agent:rdata_fifo_sink_error
	wire          fifo2mm_csr_agent_rdata_fifo_out_valid;                       // fifo2mm_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] fifo2mm_csr_agent_rdata_fifo_out_data;                        // fifo2mm_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          fifo2mm_csr_agent_rdata_fifo_out_ready;                       // avalon_st_adapter_002:in_0_ready -> fifo2mm_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                            // avalon_st_adapter_002:out_0_valid -> fifo2mm_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                             // avalon_st_adapter_002:out_0_data -> fifo2mm_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                            // fifo2mm_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                            // avalon_st_adapter_002:out_0_error -> fifo2mm_csr_agent:rdata_fifo_sink_error
	...
	wire          fir_out_ram_s1_agent_rdata_fifo_out_valid;                    // fir_out_RAM_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [65:0] fir_out_ram_s1_agent_rdata_fifo_out_data;                     // fir_out_RAM_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          fir_out_ram_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_006:in_0_ready -> fir_out_RAM_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                            // avalon_st_adapter_006:out_0_valid -> fir_out_RAM_s1_agent:rdata_fifo_sink_valid
	wire   [65:0] avalon_st_adapter_006_out_0_data;                             // avalon_st_adapter_006:out_0_data -> fir_out_RAM_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                            // fir_out_RAM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                            // avalon_st_adapter_006:out_0_error -> fir_out_RAM_s1_agent:rdata_fifo_sink_error
	wire          fir_in_ram_s1_agent_rdata_fifo_out_valid;                     // fir_in_RAM_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [65:0] fir_in_ram_s1_agent_rdata_fifo_out_data;                      // fir_in_RAM_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          fir_in_ram_s1_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_007:in_0_ready -> fir_in_RAM_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_007_out_0_valid;                            // avalon_st_adapter_007:out_0_valid -> fir_in_RAM_s1_agent:rdata_fifo_sink_valid
	wire   [65:0] avalon_st_adapter_007_out_0_data;                             // avalon_st_adapter_007:out_0_data -> fir_in_RAM_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                            // fir_in_RAM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                            // avalon_st_adapter_007:out_0_error -> fir_in_RAM_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) mm2fifo_csr_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (mm2fifo_csr_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (mm2fifo_csr_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (mm2fifo_csr_agent_m0_read),                    //                         .read
		.uav_write              (mm2fifo_csr_agent_m0_write),                   //                         .write
		.uav_waitrequest        (mm2fifo_csr_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (mm2fifo_csr_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (mm2fifo_csr_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (mm2fifo_csr_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (mm2fifo_csr_agent_m0_writedata),               //                         .writedata
		.uav_lock               (mm2fifo_csr_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (mm2fifo_csr_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (mm2fifo_csr_address),                          //      avalon_anti_slave_0.address
		.av_write               (mm2fifo_csr_write),                            //                         .write
		.av_read                (mm2fifo_csr_read),                             //                         .read
		.av_readdata            (mm2fifo_csr_readdata),                         //                         .readdata
		.av_writedata           (mm2fifo_csr_writedata),                        //                         .writedata
		.av_chipselect          (mm2fifo_csr_chipselect),                       //                         .chipselect
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
		.av_byteenable          (),                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fifo2mm_csr_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fifo2mm_csr_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (fifo2mm_csr_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (fifo2mm_csr_agent_m0_read),                    //                         .read
		.uav_write              (fifo2mm_csr_agent_m0_write),                   //                         .write
		.uav_waitrequest        (fifo2mm_csr_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (fifo2mm_csr_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (fifo2mm_csr_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (fifo2mm_csr_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (fifo2mm_csr_agent_m0_writedata),               //                         .writedata
		.uav_lock               (fifo2mm_csr_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (fifo2mm_csr_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (fifo2mm_csr_address),                          //      avalon_anti_slave_0.address
		.av_write               (fifo2mm_csr_write),                            //                         .write
		.av_read                (fifo2mm_csr_read),                             //                         .read
		.av_readdata            (fifo2mm_csr_readdata),                         //                         .readdata
		.av_writedata           (fifo2mm_csr_writedata),                        //                         .writedata
		.av_chipselect          (fifo2mm_csr_chipselect),                       //                         .chipselect
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
		.av_byteenable          (),                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fir_out_ram_s1_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fir_out_ram_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (fir_out_ram_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (fir_out_ram_s1_agent_m0_read),                 //                         .read
		.uav_write              (fir_out_ram_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (fir_out_ram_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (fir_out_ram_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (fir_out_ram_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (fir_out_ram_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (fir_out_ram_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (fir_out_ram_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (fir_out_ram_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (fir_out_RAM_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (fir_out_RAM_s1_write),                         //                         .write
		.av_readdata            (fir_out_RAM_s1_readdata),                      //                         .readdata
		.av_writedata           (fir_out_RAM_s1_writedata),                     //                         .writedata
		.av_byteenable          (fir_out_RAM_s1_byteenable),                    //                         .byteenable
		.av_chipselect          (fir_out_RAM_s1_chipselect),                    //                         .chipselect
		.av_clken               (fir_out_RAM_s1_clken),                         //                         .clken
		.av_read                (),                                             //              (terminated)
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fir_in_ram_s1_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fir_in_ram_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (fir_in_ram_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (fir_in_ram_s1_agent_m0_read),                  //                         .read
		.uav_write              (fir_in_ram_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (fir_in_ram_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (fir_in_ram_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (fir_in_ram_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (fir_in_ram_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (fir_in_ram_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (fir_in_ram_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (fir_in_ram_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (fir_in_RAM_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (fir_in_RAM_s1_write),                          //                         .write
		.av_readdata            (fir_in_RAM_s1_readdata),                       //                         .readdata
		.av_writedata           (fir_in_RAM_s1_writedata),                      //                         .writedata
		.av_byteenable          (fir_in_RAM_s1_byteenable),                     //                         .byteenable
		.av_chipselect          (fir_in_RAM_s1_chipselect),                     //                         .chipselect
		.av_clken               (fir_in_RAM_s1_clken),                          //                         .clken
		.av_read                (),                                             //              (terminated)
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (mm2fifo_csr_agent_m0_address),                    //              m0.address
		.m0_burstcount           (mm2fifo_csr_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (mm2fifo_csr_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (mm2fifo_csr_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (mm2fifo_csr_agent_m0_lock),                       //                .lock
		.m0_readdata             (mm2fifo_csr_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (mm2fifo_csr_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (mm2fifo_csr_agent_m0_read),                       //                .read
		.m0_waitrequest          (mm2fifo_csr_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (mm2fifo_csr_agent_m0_writedata),                  //                .writedata
		.m0_write                (mm2fifo_csr_agent_m0_write),                      //                .write
		.rp_endofpacket          (mm2fifo_csr_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (mm2fifo_csr_agent_rp_ready),                      //                .ready
		.rp_valid                (mm2fifo_csr_agent_rp_valid),                      //                .valid
		.rp_data                 (mm2fifo_csr_agent_rp_data),                       //                .data
		.rp_startofpacket        (mm2fifo_csr_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (mm2fifo_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (mm2fifo_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (mm2fifo_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (mm2fifo_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (mm2fifo_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (mm2fifo_csr_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (mm2fifo_csr_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (mm2fifo_csr_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (mm2fifo_csr_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (mm2fifo_csr_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (mm2fifo_csr_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (mm2fifo_csr_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (mm2fifo_csr_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (mm2fifo_csr_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (mm2fifo_csr_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (mm2fifo_csr_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),               //                .error
		.rdata_fifo_src_ready    (mm2fifo_csr_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (mm2fifo_csr_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (mm2fifo_csr_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) mm2fifo_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (mm2fifo_csr_agent_rf_source_data),             //        in.data
		.in_valid          (mm2fifo_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (mm2fifo_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (mm2fifo_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (mm2fifo_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (mm2fifo_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (mm2fifo_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (mm2fifo_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (mm2fifo_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (mm2fifo_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) mm2fifo_csr_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (mm2fifo_csr_agent_rdata_fifo_src_data),        //        in.data
		.in_valid          (mm2fifo_csr_agent_rdata_fifo_src_valid),       //          .valid
		.in_ready          (mm2fifo_csr_agent_rdata_fifo_src_ready),       //          .ready
		.out_data          (mm2fifo_csr_agent_rdata_fifo_out_data),        //       out.data
		.out_valid         (mm2fifo_csr_agent_rdata_fifo_out_valid),       //          .valid
		.out_ready         (mm2fifo_csr_agent_rdata_fifo_out_ready),       //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (fifo2mm_csr_agent_m0_address),                    //              m0.address
		.m0_burstcount           (fifo2mm_csr_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (fifo2mm_csr_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (fifo2mm_csr_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (fifo2mm_csr_agent_m0_lock),                       //                .lock
		.m0_readdata             (fifo2mm_csr_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (fifo2mm_csr_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (fifo2mm_csr_agent_m0_read),                       //                .read
		.m0_waitrequest          (fifo2mm_csr_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (fifo2mm_csr_agent_m0_writedata),                  //                .writedata
		.m0_write                (fifo2mm_csr_agent_m0_write),                      //                .write
		.rp_endofpacket          (fifo2mm_csr_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (fifo2mm_csr_agent_rp_ready),                      //                .ready
		.rp_valid                (fifo2mm_csr_agent_rp_valid),                      //                .valid
		.rp_data                 (fifo2mm_csr_agent_rp_data),                       //                .data
		.rp_startofpacket        (fifo2mm_csr_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (fifo2mm_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fifo2mm_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fifo2mm_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fifo2mm_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fifo2mm_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fifo2mm_csr_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (fifo2mm_csr_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (fifo2mm_csr_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (fifo2mm_csr_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (fifo2mm_csr_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (fifo2mm_csr_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (fifo2mm_csr_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (fifo2mm_csr_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (fifo2mm_csr_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (fifo2mm_csr_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (fifo2mm_csr_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),               //                .error
		.rdata_fifo_src_ready    (fifo2mm_csr_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fifo2mm_csr_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (fifo2mm_csr_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo2mm_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo2mm_csr_agent_rf_source_data),             //        in.data
		.in_valid          (fifo2mm_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (fifo2mm_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fifo2mm_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fifo2mm_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fifo2mm_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fifo2mm_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fifo2mm_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fifo2mm_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fifo2mm_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo2mm_csr_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo2mm_csr_agent_rdata_fifo_src_data),        //        in.data
		.in_valid          (fifo2mm_csr_agent_rdata_fifo_src_valid),       //          .valid
		.in_ready          (fifo2mm_csr_agent_rdata_fifo_src_ready),       //          .ready
		.out_data          (fifo2mm_csr_agent_rdata_fifo_out_data),        //       out.data
		.out_valid         (fifo2mm_csr_agent_rdata_fifo_out_valid),       //          .valid
		.out_ready         (fifo2mm_csr_agent_rdata_fifo_out_ready),       //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) fir_out_ram_s1_agent (
		.clk                     (clk_0_clk_clk),                                      //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (fir_out_ram_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (fir_out_ram_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (fir_out_ram_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (fir_out_ram_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (fir_out_ram_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (fir_out_ram_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (fir_out_ram_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (fir_out_ram_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (fir_out_ram_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (fir_out_ram_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (fir_out_ram_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (fir_out_ram_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (fir_out_ram_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (fir_out_ram_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (fir_out_ram_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (fir_out_ram_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (fir_out_ram_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fir_out_ram_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fir_out_ram_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fir_out_ram_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fir_out_ram_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fir_out_ram_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (fir_out_ram_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (fir_out_ram_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (fir_out_ram_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (fir_out_ram_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (fir_out_ram_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (fir_out_ram_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (fir_out_ram_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (fir_out_ram_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (fir_out_ram_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (fir_out_ram_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (fir_out_ram_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fir_out_ram_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (fir_out_ram_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fir_out_ram_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                   //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (fir_out_ram_s1_agent_rf_source_data),             //        in.data
		.in_valid          (fir_out_ram_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (fir_out_ram_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fir_out_ram_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fir_out_ram_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fir_out_ram_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fir_out_ram_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fir_out_ram_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fir_out_ram_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fir_out_ram_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fir_out_ram_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fir_out_ram_s1_agent_rdata_fifo_src_data),     //        in.data
		.in_valid          (fir_out_ram_s1_agent_rdata_fifo_src_valid),    //          .valid
		.in_ready          (fir_out_ram_s1_agent_rdata_fifo_src_ready),    //          .ready
		.out_data          (fir_out_ram_s1_agent_rdata_fifo_out_data),     //       out.data
		.out_valid         (fir_out_ram_s1_agent_rdata_fifo_out_valid),    //          .valid
		.out_ready         (fir_out_ram_s1_agent_rdata_fifo_out_ready),    //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (fir_in_ram_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (fir_in_ram_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (fir_in_ram_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (fir_in_ram_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (fir_in_ram_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (fir_in_ram_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (fir_in_ram_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (fir_in_ram_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (fir_in_ram_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (fir_in_ram_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (fir_in_ram_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (fir_in_ram_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (fir_in_ram_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (fir_in_ram_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (fir_in_ram_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (fir_in_ram_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (fir_in_ram_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fir_in_ram_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fir_in_ram_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fir_in_ram_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fir_in_ram_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fir_in_ram_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (fir_in_ram_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (fir_in_ram_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (fir_in_ram_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (fir_in_ram_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (fir_in_ram_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (fir_in_ram_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (fir_in_ram_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (fir_in_ram_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (fir_in_ram_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (fir_in_ram_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (fir_in_ram_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fir_in_ram_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (fir_in_ram_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fir_in_ram_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (fir_in_ram_s1_agent_rf_source_data),             //        in.data
		.in_valid          (fir_in_ram_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (fir_in_ram_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fir_in_ram_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fir_in_ram_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fir_in_ram_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fir_in_ram_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fir_in_ram_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fir_in_ram_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fir_in_ram_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fir_in_ram_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fir_in_ram_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (fir_in_ram_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (fir_in_ram_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (fir_in_ram_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (fir_in_ram_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (fir_in_ram_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	soc_system_mm_interconnect_3_router_002 router_003 (
		.sink_ready         (mm2fifo_csr_agent_rp_ready),                   //      sink.ready
		.sink_valid         (mm2fifo_csr_agent_rp_valid),                   //          .valid
		.sink_data          (mm2fifo_csr_agent_rp_data),                    //          .data
		.sink_startofpacket (mm2fifo_csr_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (mm2fifo_csr_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_3_router_002 router_004 (
		.sink_ready         (fifo2mm_csr_agent_rp_ready),                   //      sink.ready
		.sink_valid         (fifo2mm_csr_agent_rp_valid),                   //          .valid
		.sink_data          (fifo2mm_csr_agent_rp_data),                    //          .data
		.sink_startofpacket (fifo2mm_csr_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (fifo2mm_csr_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_3_router_008 router_008 (
		.sink_ready         (fir_out_ram_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (fir_out_ram_s1_agent_rp_valid),                //          .valid
		.sink_data          (fir_out_ram_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (fir_out_ram_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (fir_out_ram_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_3_router_008 router_009 (
		.sink_ready         (fir_in_ram_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (fir_in_ram_s1_agent_rp_valid),                 //          .valid
		.sink_data          (fir_in_ram_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (fir_in_ram_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (fir_in_ram_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (mm2fifo_csr_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (mm2fifo_csr_burst_adapter_source0_data),          //          .data
		.source0_channel       (mm2fifo_csr_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (mm2fifo_csr_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (mm2fifo_csr_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (mm2fifo_csr_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (fifo2mm_csr_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fifo2mm_csr_burst_adapter_source0_data),          //          .data
		.source0_channel       (fifo2mm_csr_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fifo2mm_csr_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fifo2mm_csr_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fifo2mm_csr_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) fir_out_ram_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                      //       cr0.clk
		.reset                 (sysid_qsys_reset_reset_bridge_in_reset_reset),       // cr0_reset.reset
		.sink0_valid           (fir_out_ram_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (fir_out_ram_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (fir_out_ram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (fir_out_ram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (fir_out_ram_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (fir_out_ram_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (fir_out_ram_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fir_out_ram_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (fir_out_ram_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fir_out_ram_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fir_out_ram_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fir_out_ram_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) fir_in_ram_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                     //       cr0.clk
		.reset                 (sysid_qsys_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		.sink0_valid           (fir_in_ram_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (fir_in_ram_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (fir_in_ram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (fir_in_ram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (fir_in_ram_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (fir_in_ram_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (fir_in_ram_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fir_in_ram_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (fir_in_ram_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fir_in_ram_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fir_in_ram_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fir_in_ram_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_3_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.sink_ready         (fir_out_ram_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (fir_out_ram_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (fir_out_ram_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (fir_out_ram_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (fir_out_ram_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (fir_out_ram_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	soc_system_mm_interconnect_3_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.sink_ready         (fir_in_ram_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (fir_in_ram_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (fir_in_ram_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (fir_in_ram_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (fir_in_ram_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (fir_in_ram_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) fir_out_ram_s1_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                      //       clk.clk
		.reset                (sysid_qsys_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		...
		.out_endofpacket      (fir_out_ram_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (fir_out_ram_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (fir_out_ram_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (fir_out_ram_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (fir_out_ram_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (fir_out_ram_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) fir_in_ram_s1_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                     //       clk.clk
		.reset                (sysid_qsys_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		...
		.out_endofpacket      (fir_in_ram_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (fir_in_ram_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (fir_in_ram_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (fir_in_ram_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (fir_in_ram_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (fir_in_ram_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                             // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) fir_out_ram_s1_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                      //       clk.clk
		.reset                (sysid_qsys_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		...
		.out_endofpacket      (fir_out_ram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (fir_out_ram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (fir_out_ram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (fir_out_ram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (fir_out_ram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (fir_out_ram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                              // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) fir_in_ram_s1_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                     //       clk.clk
		.reset                (sysid_qsys_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		...
		.out_endofpacket      (fir_in_ram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (fir_in_ram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (fir_in_ram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (fir_in_ram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (fir_in_ram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (fir_in_ram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                             // (terminated)
	);
	...
	soc_system_mm_interconnect_3_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (mm2fifo_csr_agent_rdata_fifo_out_data),        //     in_0.data
		.in_0_valid     (mm2fifo_csr_agent_rdata_fifo_out_valid),       //         .valid
		.in_0_ready     (mm2fifo_csr_agent_rdata_fifo_out_ready),       //         .ready
	...
	soc_system_mm_interconnect_3_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fifo2mm_csr_agent_rdata_fifo_out_data),        //     in_0.data
		.in_0_valid     (fifo2mm_csr_agent_rdata_fifo_out_valid),       //         .valid
		.in_0_ready     (fifo2mm_csr_agent_rdata_fifo_out_ready),       //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fir_out_ram_s1_agent_rdata_fifo_out_data),     //     in_0.data
		.in_0_valid     (fir_out_ram_s1_agent_rdata_fifo_out_valid),    //         .valid
		.in_0_ready     (fir_out_ram_s1_agent_rdata_fifo_out_ready),    //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fir_in_ram_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (fir_in_ram_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (fir_in_ram_s1_agent_rdata_fifo_out_ready),     //         .ready
