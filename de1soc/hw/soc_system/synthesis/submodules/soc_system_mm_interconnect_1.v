...
module soc_system_mm_interconnect_1 (
		...
		output wire [1:0]  fifo_in_csr_address,                                                 //                                                   fifo_in_csr.address
		...
		output wire [1:0]  fifo_out_csr_address,                                                //                                                  fifo_out_csr.address
	...
	wire   [20:0] fifo_out_csr_agent_m0_address;                                // fifo_out_csr_agent:m0_address -> fifo_out_csr_translator:uav_address
	...
	wire  [118:0] fifo_out_csr_agent_rf_source_data;                            // fifo_out_csr_agent:rf_source_data -> fifo_out_csr_agent_rsp_fifo:in_data
	...
	wire  [118:0] fifo_out_csr_agent_rsp_fifo_out_data;                         // fifo_out_csr_agent_rsp_fifo:out_data -> fifo_out_csr_agent:rf_sink_data
	...
	wire          fifo_out_csr_agent_rp_valid;                                  // fifo_out_csr_agent:rp_valid -> router_003:sink_valid
	wire  [117:0] fifo_out_csr_agent_rp_data;                                   // fifo_out_csr_agent:rp_data -> router_003:sink_data
	wire          fifo_out_csr_agent_rp_ready;                                  // router_003:sink_ready -> fifo_out_csr_agent:rp_ready
	wire          fifo_out_csr_agent_rp_startofpacket;                          // fifo_out_csr_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          fifo_out_csr_agent_rp_endofpacket;                            // fifo_out_csr_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [117:0] fifo_in_csr_agent_rp_data;                                    // fifo_in_csr_agent:rp_data -> router_004:sink_data
	...
	wire          cmd_mux_001_src_valid;                                        // cmd_mux_001:src_valid -> fifo_out_csr_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_001_src_data;                                         // cmd_mux_001:src_data -> fifo_out_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                        // fifo_out_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [8:0] cmd_mux_001_src_channel;                                      // cmd_mux_001:src_channel -> fifo_out_csr_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                // cmd_mux_001:src_startofpacket -> fifo_out_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                  // cmd_mux_001:src_endofpacket -> fifo_out_csr_burst_adapter:sink0_endofpacket
	wire          fifo_out_csr_burst_adapter_source0_valid;                     // fifo_out_csr_burst_adapter:source0_valid -> fifo_out_csr_agent:cp_valid
	wire  [117:0] fifo_out_csr_burst_adapter_source0_data;                      // fifo_out_csr_burst_adapter:source0_data -> fifo_out_csr_agent:cp_data
	wire          fifo_out_csr_burst_adapter_source0_ready;                     // fifo_out_csr_agent:cp_ready -> fifo_out_csr_burst_adapter:source0_ready
	wire    [8:0] fifo_out_csr_burst_adapter_source0_channel;                   // fifo_out_csr_burst_adapter:source0_channel -> fifo_out_csr_agent:cp_channel
	wire          fifo_out_csr_burst_adapter_source0_startofpacket;             // fifo_out_csr_burst_adapter:source0_startofpacket -> fifo_out_csr_agent:cp_startofpacket
	wire          fifo_out_csr_burst_adapter_source0_endofpacket;               // fifo_out_csr_burst_adapter:source0_endofpacket -> fifo_out_csr_agent:cp_endofpacket
	wire          cmd_mux_002_src_valid;                                        // cmd_mux_002:src_valid -> fifo_in_csr_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_002_src_data;                                         // cmd_mux_002:src_data -> fifo_in_csr_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                        // fifo_in_csr_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                      // cmd_mux_002:src_channel -> fifo_in_csr_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                // cmd_mux_002:src_startofpacket -> fifo_in_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                  // cmd_mux_002:src_endofpacket -> fifo_in_csr_burst_adapter:sink0_endofpacket
	...
	wire    [8:0] fifo_in_csr_burst_adapter_source0_channel;                    // fifo_in_csr_burst_adapter:source0_channel -> fifo_in_csr_agent:cp_channel
	...
	wire          fifo_out_csr_agent_rdata_fifo_out_valid;                      // fifo_out_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] fifo_out_csr_agent_rdata_fifo_out_data;                       // fifo_out_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          fifo_out_csr_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_001:in_0_ready -> fifo_out_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                            // avalon_st_adapter_001:out_0_valid -> fifo_out_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                             // avalon_st_adapter_001:out_0_data -> fifo_out_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                            // fifo_out_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                            // avalon_st_adapter_001:out_0_error -> fifo_out_csr_agent:rdata_fifo_sink_error
	wire          fifo_in_csr_agent_rdata_fifo_out_valid;                       // fifo_in_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] fifo_in_csr_agent_rdata_fifo_out_data;                        // fifo_in_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          fifo_in_csr_agent_rdata_fifo_out_ready;                       // avalon_st_adapter_002:in_0_ready -> fifo_in_csr_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (fifo_out_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fifo_out_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fifo_out_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fifo_out_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fifo_out_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fifo_out_csr_burst_adapter_source0_channel),       //                .channel
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (fifo_out_csr_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fifo_out_csr_burst_adapter_source0_data),          //          .data
		.source0_channel       (fifo_out_csr_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fifo_out_csr_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fifo_out_csr_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fifo_out_csr_burst_adapter_source0_ready)          //          .ready
	);
