...
module soc_system_mm_interconnect_1 (
		...
		output wire [1:0]  fir_fifo_in_csr_address,                                             //                                               fir_fifo_in_csr.address
		output wire        fir_fifo_in_csr_write,                                               //                                                              .write
		output wire        fir_fifo_in_csr_read,                                                //                                                              .read
		input  wire [31:0] fir_fifo_in_csr_readdata,                                            //                                                              .readdata
		output wire [31:0] fir_fifo_in_csr_writedata,                                           //                                                              .writedata
		output wire [1:0]  fir_fifo_out_csr_address,                                            //                                              fir_fifo_out_csr.address
		output wire        fir_fifo_out_csr_write,                                              //                                                              .write
		output wire        fir_fifo_out_csr_read,                                               //                                                              .read
		input  wire [31:0] fir_fifo_out_csr_readdata,                                           //                                                              .readdata
		output wire [31:0] fir_fifo_out_csr_writedata,                                          //                                                              .writedata
		...
		output wire [0:0]  sample2lvl_converter_0_csr_address,                                  //                                    sample2lvl_converter_0_csr.address
		output wire        sample2lvl_converter_0_csr_write,                                    //                                                              .write
		output wire        sample2lvl_converter_0_csr_read,                                     //                                                              .read
		input  wire [31:0] sample2lvl_converter_0_csr_readdata,                                 //                                                              .readdata
		output wire [31:0] sample2lvl_converter_0_csr_writedata,                                //                                                              .writedata
		output wire [3:0]  sample2lvl_converter_0_csr_byteenable,                               //                                                              .byteenable
		input  wire        sample2lvl_converter_0_csr_waitrequest,                              //                                                              .waitrequest
		output wire        sample2lvl_converter_0_csr_chipselect,                               //                                                              .chipselect
		output wire [3:0]  sgdma_mm2st_csr_address,                                             //                                               sgdma_mm2st_csr.address
		output wire        sgdma_mm2st_csr_write,                                               //                                                              .write
		output wire        sgdma_mm2st_csr_read,                                                //                                                              .read
		input  wire [31:0] sgdma_mm2st_csr_readdata,                                            //                                                              .readdata
		output wire [31:0] sgdma_mm2st_csr_writedata,                                           //                                                              .writedata
		output wire        sgdma_mm2st_csr_chipselect,                                          //                                                              .chipselect
		output wire [3:0]  sgdma_st2mm_csr_address,                                             //                                               sgdma_st2mm_csr.address
		output wire        sgdma_st2mm_csr_write,                                               //                                                              .write
		output wire        sgdma_st2mm_csr_read,                                                //                                                              .read
		input  wire [31:0] sgdma_st2mm_csr_readdata,                                            //                                                              .readdata
		output wire [31:0] sgdma_st2mm_csr_writedata,                                           //                                                              .writedata
		output wire        sgdma_st2mm_csr_chipselect,                                          //                                                              .chipselect
	...
	wire   [31:0] fir_fifo_out_csr_agent_m0_readdata;                             // fir_fifo_out_csr_translator:uav_readdata -> fir_fifo_out_csr_agent:m0_readdata
	wire          fir_fifo_out_csr_agent_m0_waitrequest;                          // fir_fifo_out_csr_translator:uav_waitrequest -> fir_fifo_out_csr_agent:m0_waitrequest
	wire          fir_fifo_out_csr_agent_m0_debugaccess;                          // fir_fifo_out_csr_agent:m0_debugaccess -> fir_fifo_out_csr_translator:uav_debugaccess
	wire   [20:0] fir_fifo_out_csr_agent_m0_address;                              // fir_fifo_out_csr_agent:m0_address -> fir_fifo_out_csr_translator:uav_address
	wire    [3:0] fir_fifo_out_csr_agent_m0_byteenable;                           // fir_fifo_out_csr_agent:m0_byteenable -> fir_fifo_out_csr_translator:uav_byteenable
	wire          fir_fifo_out_csr_agent_m0_read;                                 // fir_fifo_out_csr_agent:m0_read -> fir_fifo_out_csr_translator:uav_read
	wire          fir_fifo_out_csr_agent_m0_readdatavalid;                        // fir_fifo_out_csr_translator:uav_readdatavalid -> fir_fifo_out_csr_agent:m0_readdatavalid
	wire          fir_fifo_out_csr_agent_m0_lock;                                 // fir_fifo_out_csr_agent:m0_lock -> fir_fifo_out_csr_translator:uav_lock
	wire   [31:0] fir_fifo_out_csr_agent_m0_writedata;                            // fir_fifo_out_csr_agent:m0_writedata -> fir_fifo_out_csr_translator:uav_writedata
	wire          fir_fifo_out_csr_agent_m0_write;                                // fir_fifo_out_csr_agent:m0_write -> fir_fifo_out_csr_translator:uav_write
	wire    [2:0] fir_fifo_out_csr_agent_m0_burstcount;                           // fir_fifo_out_csr_agent:m0_burstcount -> fir_fifo_out_csr_translator:uav_burstcount
	wire          fir_fifo_out_csr_agent_rf_source_valid;                         // fir_fifo_out_csr_agent:rf_source_valid -> fir_fifo_out_csr_agent_rsp_fifo:in_valid
	wire  [118:0] fir_fifo_out_csr_agent_rf_source_data;                          // fir_fifo_out_csr_agent:rf_source_data -> fir_fifo_out_csr_agent_rsp_fifo:in_data
	wire          fir_fifo_out_csr_agent_rf_source_ready;                         // fir_fifo_out_csr_agent_rsp_fifo:in_ready -> fir_fifo_out_csr_agent:rf_source_ready
	wire          fir_fifo_out_csr_agent_rf_source_startofpacket;                 // fir_fifo_out_csr_agent:rf_source_startofpacket -> fir_fifo_out_csr_agent_rsp_fifo:in_startofpacket
	wire          fir_fifo_out_csr_agent_rf_source_endofpacket;                   // fir_fifo_out_csr_agent:rf_source_endofpacket -> fir_fifo_out_csr_agent_rsp_fifo:in_endofpacket
	wire          fir_fifo_out_csr_agent_rsp_fifo_out_valid;                      // fir_fifo_out_csr_agent_rsp_fifo:out_valid -> fir_fifo_out_csr_agent:rf_sink_valid
	wire  [118:0] fir_fifo_out_csr_agent_rsp_fifo_out_data;                       // fir_fifo_out_csr_agent_rsp_fifo:out_data -> fir_fifo_out_csr_agent:rf_sink_data
	wire          fir_fifo_out_csr_agent_rsp_fifo_out_ready;                      // fir_fifo_out_csr_agent:rf_sink_ready -> fir_fifo_out_csr_agent_rsp_fifo:out_ready
	wire          fir_fifo_out_csr_agent_rsp_fifo_out_startofpacket;              // fir_fifo_out_csr_agent_rsp_fifo:out_startofpacket -> fir_fifo_out_csr_agent:rf_sink_startofpacket
	wire          fir_fifo_out_csr_agent_rsp_fifo_out_endofpacket;                // fir_fifo_out_csr_agent_rsp_fifo:out_endofpacket -> fir_fifo_out_csr_agent:rf_sink_endofpacket
	wire          fir_fifo_out_csr_agent_rdata_fifo_src_valid;                    // fir_fifo_out_csr_agent:rdata_fifo_src_valid -> fir_fifo_out_csr_agent_rdata_fifo:in_valid
	wire   [33:0] fir_fifo_out_csr_agent_rdata_fifo_src_data;                     // fir_fifo_out_csr_agent:rdata_fifo_src_data -> fir_fifo_out_csr_agent_rdata_fifo:in_data
	wire          fir_fifo_out_csr_agent_rdata_fifo_src_ready;                    // fir_fifo_out_csr_agent_rdata_fifo:in_ready -> fir_fifo_out_csr_agent:rdata_fifo_src_ready
	wire   [31:0] fir_fifo_in_csr_agent_m0_readdata;                              // fir_fifo_in_csr_translator:uav_readdata -> fir_fifo_in_csr_agent:m0_readdata
	wire          fir_fifo_in_csr_agent_m0_waitrequest;                           // fir_fifo_in_csr_translator:uav_waitrequest -> fir_fifo_in_csr_agent:m0_waitrequest
	wire          fir_fifo_in_csr_agent_m0_debugaccess;                           // fir_fifo_in_csr_agent:m0_debugaccess -> fir_fifo_in_csr_translator:uav_debugaccess
	wire   [20:0] fir_fifo_in_csr_agent_m0_address;                               // fir_fifo_in_csr_agent:m0_address -> fir_fifo_in_csr_translator:uav_address
	wire    [3:0] fir_fifo_in_csr_agent_m0_byteenable;                            // fir_fifo_in_csr_agent:m0_byteenable -> fir_fifo_in_csr_translator:uav_byteenable
	wire          fir_fifo_in_csr_agent_m0_read;                                  // fir_fifo_in_csr_agent:m0_read -> fir_fifo_in_csr_translator:uav_read
	wire          fir_fifo_in_csr_agent_m0_readdatavalid;                         // fir_fifo_in_csr_translator:uav_readdatavalid -> fir_fifo_in_csr_agent:m0_readdatavalid
	wire          fir_fifo_in_csr_agent_m0_lock;                                  // fir_fifo_in_csr_agent:m0_lock -> fir_fifo_in_csr_translator:uav_lock
	wire   [31:0] fir_fifo_in_csr_agent_m0_writedata;                             // fir_fifo_in_csr_agent:m0_writedata -> fir_fifo_in_csr_translator:uav_writedata
	wire          fir_fifo_in_csr_agent_m0_write;                                 // fir_fifo_in_csr_agent:m0_write -> fir_fifo_in_csr_translator:uav_write
	wire    [2:0] fir_fifo_in_csr_agent_m0_burstcount;                            // fir_fifo_in_csr_agent:m0_burstcount -> fir_fifo_in_csr_translator:uav_burstcount
	wire          fir_fifo_in_csr_agent_rf_source_valid;                          // fir_fifo_in_csr_agent:rf_source_valid -> fir_fifo_in_csr_agent_rsp_fifo:in_valid
	wire  [118:0] fir_fifo_in_csr_agent_rf_source_data;                           // fir_fifo_in_csr_agent:rf_source_data -> fir_fifo_in_csr_agent_rsp_fifo:in_data
	wire          fir_fifo_in_csr_agent_rf_source_ready;                          // fir_fifo_in_csr_agent_rsp_fifo:in_ready -> fir_fifo_in_csr_agent:rf_source_ready
	wire          fir_fifo_in_csr_agent_rf_source_startofpacket;                  // fir_fifo_in_csr_agent:rf_source_startofpacket -> fir_fifo_in_csr_agent_rsp_fifo:in_startofpacket
	wire          fir_fifo_in_csr_agent_rf_source_endofpacket;                    // fir_fifo_in_csr_agent:rf_source_endofpacket -> fir_fifo_in_csr_agent_rsp_fifo:in_endofpacket
	wire          fir_fifo_in_csr_agent_rsp_fifo_out_valid;                       // fir_fifo_in_csr_agent_rsp_fifo:out_valid -> fir_fifo_in_csr_agent:rf_sink_valid
	wire  [118:0] fir_fifo_in_csr_agent_rsp_fifo_out_data;                        // fir_fifo_in_csr_agent_rsp_fifo:out_data -> fir_fifo_in_csr_agent:rf_sink_data
	wire          fir_fifo_in_csr_agent_rsp_fifo_out_ready;                       // fir_fifo_in_csr_agent:rf_sink_ready -> fir_fifo_in_csr_agent_rsp_fifo:out_ready
	wire          fir_fifo_in_csr_agent_rsp_fifo_out_startofpacket;               // fir_fifo_in_csr_agent_rsp_fifo:out_startofpacket -> fir_fifo_in_csr_agent:rf_sink_startofpacket
	wire          fir_fifo_in_csr_agent_rsp_fifo_out_endofpacket;                 // fir_fifo_in_csr_agent_rsp_fifo:out_endofpacket -> fir_fifo_in_csr_agent:rf_sink_endofpacket
	wire          fir_fifo_in_csr_agent_rdata_fifo_src_valid;                     // fir_fifo_in_csr_agent:rdata_fifo_src_valid -> fir_fifo_in_csr_agent_rdata_fifo:in_valid
	wire   [33:0] fir_fifo_in_csr_agent_rdata_fifo_src_data;                      // fir_fifo_in_csr_agent:rdata_fifo_src_data -> fir_fifo_in_csr_agent_rdata_fifo:in_data
	wire          fir_fifo_in_csr_agent_rdata_fifo_src_ready;                     // fir_fifo_in_csr_agent_rdata_fifo:in_ready -> fir_fifo_in_csr_agent:rdata_fifo_src_ready
	wire   [31:0] sgdma_st2mm_csr_agent_m0_readdata;                              // sgdma_st2mm_csr_translator:uav_readdata -> sgdma_st2mm_csr_agent:m0_readdata
	wire          sgdma_st2mm_csr_agent_m0_waitrequest;                           // sgdma_st2mm_csr_translator:uav_waitrequest -> sgdma_st2mm_csr_agent:m0_waitrequest
	wire          sgdma_st2mm_csr_agent_m0_debugaccess;                           // sgdma_st2mm_csr_agent:m0_debugaccess -> sgdma_st2mm_csr_translator:uav_debugaccess
	wire   [20:0] sgdma_st2mm_csr_agent_m0_address;                               // sgdma_st2mm_csr_agent:m0_address -> sgdma_st2mm_csr_translator:uav_address
	wire    [3:0] sgdma_st2mm_csr_agent_m0_byteenable;                            // sgdma_st2mm_csr_agent:m0_byteenable -> sgdma_st2mm_csr_translator:uav_byteenable
	wire          sgdma_st2mm_csr_agent_m0_read;                                  // sgdma_st2mm_csr_agent:m0_read -> sgdma_st2mm_csr_translator:uav_read
	wire          sgdma_st2mm_csr_agent_m0_readdatavalid;                         // sgdma_st2mm_csr_translator:uav_readdatavalid -> sgdma_st2mm_csr_agent:m0_readdatavalid
	wire          sgdma_st2mm_csr_agent_m0_lock;                                  // sgdma_st2mm_csr_agent:m0_lock -> sgdma_st2mm_csr_translator:uav_lock
	wire   [31:0] sgdma_st2mm_csr_agent_m0_writedata;                             // sgdma_st2mm_csr_agent:m0_writedata -> sgdma_st2mm_csr_translator:uav_writedata
	wire          sgdma_st2mm_csr_agent_m0_write;                                 // sgdma_st2mm_csr_agent:m0_write -> sgdma_st2mm_csr_translator:uav_write
	wire    [2:0] sgdma_st2mm_csr_agent_m0_burstcount;                            // sgdma_st2mm_csr_agent:m0_burstcount -> sgdma_st2mm_csr_translator:uav_burstcount
	wire          sgdma_st2mm_csr_agent_rf_source_valid;                          // sgdma_st2mm_csr_agent:rf_source_valid -> sgdma_st2mm_csr_agent_rsp_fifo:in_valid
	wire  [118:0] sgdma_st2mm_csr_agent_rf_source_data;                           // sgdma_st2mm_csr_agent:rf_source_data -> sgdma_st2mm_csr_agent_rsp_fifo:in_data
	wire          sgdma_st2mm_csr_agent_rf_source_ready;                          // sgdma_st2mm_csr_agent_rsp_fifo:in_ready -> sgdma_st2mm_csr_agent:rf_source_ready
	wire          sgdma_st2mm_csr_agent_rf_source_startofpacket;                  // sgdma_st2mm_csr_agent:rf_source_startofpacket -> sgdma_st2mm_csr_agent_rsp_fifo:in_startofpacket
	wire          sgdma_st2mm_csr_agent_rf_source_endofpacket;                    // sgdma_st2mm_csr_agent:rf_source_endofpacket -> sgdma_st2mm_csr_agent_rsp_fifo:in_endofpacket
	wire          sgdma_st2mm_csr_agent_rsp_fifo_out_valid;                       // sgdma_st2mm_csr_agent_rsp_fifo:out_valid -> sgdma_st2mm_csr_agent:rf_sink_valid
	wire  [118:0] sgdma_st2mm_csr_agent_rsp_fifo_out_data;                        // sgdma_st2mm_csr_agent_rsp_fifo:out_data -> sgdma_st2mm_csr_agent:rf_sink_data
	wire          sgdma_st2mm_csr_agent_rsp_fifo_out_ready;                       // sgdma_st2mm_csr_agent:rf_sink_ready -> sgdma_st2mm_csr_agent_rsp_fifo:out_ready
	wire          sgdma_st2mm_csr_agent_rsp_fifo_out_startofpacket;               // sgdma_st2mm_csr_agent_rsp_fifo:out_startofpacket -> sgdma_st2mm_csr_agent:rf_sink_startofpacket
	wire          sgdma_st2mm_csr_agent_rsp_fifo_out_endofpacket;                 // sgdma_st2mm_csr_agent_rsp_fifo:out_endofpacket -> sgdma_st2mm_csr_agent:rf_sink_endofpacket
	wire          sgdma_st2mm_csr_agent_rdata_fifo_src_valid;                     // sgdma_st2mm_csr_agent:rdata_fifo_src_valid -> sgdma_st2mm_csr_agent_rdata_fifo:in_valid
	wire   [33:0] sgdma_st2mm_csr_agent_rdata_fifo_src_data;                      // sgdma_st2mm_csr_agent:rdata_fifo_src_data -> sgdma_st2mm_csr_agent_rdata_fifo:in_data
	wire          sgdma_st2mm_csr_agent_rdata_fifo_src_ready;                     // sgdma_st2mm_csr_agent_rdata_fifo:in_ready -> sgdma_st2mm_csr_agent:rdata_fifo_src_ready
	wire   [31:0] sgdma_mm2st_csr_agent_m0_readdata;                              // sgdma_mm2st_csr_translator:uav_readdata -> sgdma_mm2st_csr_agent:m0_readdata
	wire          sgdma_mm2st_csr_agent_m0_waitrequest;                           // sgdma_mm2st_csr_translator:uav_waitrequest -> sgdma_mm2st_csr_agent:m0_waitrequest
	wire          sgdma_mm2st_csr_agent_m0_debugaccess;                           // sgdma_mm2st_csr_agent:m0_debugaccess -> sgdma_mm2st_csr_translator:uav_debugaccess
	wire   [20:0] sgdma_mm2st_csr_agent_m0_address;                               // sgdma_mm2st_csr_agent:m0_address -> sgdma_mm2st_csr_translator:uav_address
	wire    [3:0] sgdma_mm2st_csr_agent_m0_byteenable;                            // sgdma_mm2st_csr_agent:m0_byteenable -> sgdma_mm2st_csr_translator:uav_byteenable
	wire          sgdma_mm2st_csr_agent_m0_read;                                  // sgdma_mm2st_csr_agent:m0_read -> sgdma_mm2st_csr_translator:uav_read
	wire          sgdma_mm2st_csr_agent_m0_readdatavalid;                         // sgdma_mm2st_csr_translator:uav_readdatavalid -> sgdma_mm2st_csr_agent:m0_readdatavalid
	wire          sgdma_mm2st_csr_agent_m0_lock;                                  // sgdma_mm2st_csr_agent:m0_lock -> sgdma_mm2st_csr_translator:uav_lock
	wire   [31:0] sgdma_mm2st_csr_agent_m0_writedata;                             // sgdma_mm2st_csr_agent:m0_writedata -> sgdma_mm2st_csr_translator:uav_writedata
	wire          sgdma_mm2st_csr_agent_m0_write;                                 // sgdma_mm2st_csr_agent:m0_write -> sgdma_mm2st_csr_translator:uav_write
	wire    [2:0] sgdma_mm2st_csr_agent_m0_burstcount;                            // sgdma_mm2st_csr_agent:m0_burstcount -> sgdma_mm2st_csr_translator:uav_burstcount
	wire          sgdma_mm2st_csr_agent_rf_source_valid;                          // sgdma_mm2st_csr_agent:rf_source_valid -> sgdma_mm2st_csr_agent_rsp_fifo:in_valid
	wire  [118:0] sgdma_mm2st_csr_agent_rf_source_data;                           // sgdma_mm2st_csr_agent:rf_source_data -> sgdma_mm2st_csr_agent_rsp_fifo:in_data
	wire          sgdma_mm2st_csr_agent_rf_source_ready;                          // sgdma_mm2st_csr_agent_rsp_fifo:in_ready -> sgdma_mm2st_csr_agent:rf_source_ready
	wire          sgdma_mm2st_csr_agent_rf_source_startofpacket;                  // sgdma_mm2st_csr_agent:rf_source_startofpacket -> sgdma_mm2st_csr_agent_rsp_fifo:in_startofpacket
	wire          sgdma_mm2st_csr_agent_rf_source_endofpacket;                    // sgdma_mm2st_csr_agent:rf_source_endofpacket -> sgdma_mm2st_csr_agent_rsp_fifo:in_endofpacket
	wire          sgdma_mm2st_csr_agent_rsp_fifo_out_valid;                       // sgdma_mm2st_csr_agent_rsp_fifo:out_valid -> sgdma_mm2st_csr_agent:rf_sink_valid
	wire  [118:0] sgdma_mm2st_csr_agent_rsp_fifo_out_data;                        // sgdma_mm2st_csr_agent_rsp_fifo:out_data -> sgdma_mm2st_csr_agent:rf_sink_data
	wire          sgdma_mm2st_csr_agent_rsp_fifo_out_ready;                       // sgdma_mm2st_csr_agent:rf_sink_ready -> sgdma_mm2st_csr_agent_rsp_fifo:out_ready
	wire          sgdma_mm2st_csr_agent_rsp_fifo_out_startofpacket;               // sgdma_mm2st_csr_agent_rsp_fifo:out_startofpacket -> sgdma_mm2st_csr_agent:rf_sink_startofpacket
	wire          sgdma_mm2st_csr_agent_rsp_fifo_out_endofpacket;                 // sgdma_mm2st_csr_agent_rsp_fifo:out_endofpacket -> sgdma_mm2st_csr_agent:rf_sink_endofpacket
	wire          sgdma_mm2st_csr_agent_rdata_fifo_src_valid;                     // sgdma_mm2st_csr_agent:rdata_fifo_src_valid -> sgdma_mm2st_csr_agent_rdata_fifo:in_valid
	wire   [33:0] sgdma_mm2st_csr_agent_rdata_fifo_src_data;                      // sgdma_mm2st_csr_agent:rdata_fifo_src_data -> sgdma_mm2st_csr_agent_rdata_fifo:in_data
	wire          sgdma_mm2st_csr_agent_rdata_fifo_src_ready;                     // sgdma_mm2st_csr_agent_rdata_fifo:in_ready -> sgdma_mm2st_csr_agent:rdata_fifo_src_ready
	wire   [31:0] sample2lvl_converter_0_csr_agent_m0_readdata;                   // sample2lvl_converter_0_csr_translator:uav_readdata -> sample2lvl_converter_0_csr_agent:m0_readdata
	wire          sample2lvl_converter_0_csr_agent_m0_waitrequest;                // sample2lvl_converter_0_csr_translator:uav_waitrequest -> sample2lvl_converter_0_csr_agent:m0_waitrequest
	wire          sample2lvl_converter_0_csr_agent_m0_debugaccess;                // sample2lvl_converter_0_csr_agent:m0_debugaccess -> sample2lvl_converter_0_csr_translator:uav_debugaccess
	wire   [20:0] sample2lvl_converter_0_csr_agent_m0_address;                    // sample2lvl_converter_0_csr_agent:m0_address -> sample2lvl_converter_0_csr_translator:uav_address
	wire    [3:0] sample2lvl_converter_0_csr_agent_m0_byteenable;                 // sample2lvl_converter_0_csr_agent:m0_byteenable -> sample2lvl_converter_0_csr_translator:uav_byteenable
	wire          sample2lvl_converter_0_csr_agent_m0_read;                       // sample2lvl_converter_0_csr_agent:m0_read -> sample2lvl_converter_0_csr_translator:uav_read
	wire          sample2lvl_converter_0_csr_agent_m0_readdatavalid;              // sample2lvl_converter_0_csr_translator:uav_readdatavalid -> sample2lvl_converter_0_csr_agent:m0_readdatavalid
	wire          sample2lvl_converter_0_csr_agent_m0_lock;                       // sample2lvl_converter_0_csr_agent:m0_lock -> sample2lvl_converter_0_csr_translator:uav_lock
	wire   [31:0] sample2lvl_converter_0_csr_agent_m0_writedata;                  // sample2lvl_converter_0_csr_agent:m0_writedata -> sample2lvl_converter_0_csr_translator:uav_writedata
	wire          sample2lvl_converter_0_csr_agent_m0_write;                      // sample2lvl_converter_0_csr_agent:m0_write -> sample2lvl_converter_0_csr_translator:uav_write
	wire    [2:0] sample2lvl_converter_0_csr_agent_m0_burstcount;                 // sample2lvl_converter_0_csr_agent:m0_burstcount -> sample2lvl_converter_0_csr_translator:uav_burstcount
	wire          sample2lvl_converter_0_csr_agent_rf_source_valid;               // sample2lvl_converter_0_csr_agent:rf_source_valid -> sample2lvl_converter_0_csr_agent_rsp_fifo:in_valid
	wire  [118:0] sample2lvl_converter_0_csr_agent_rf_source_data;                // sample2lvl_converter_0_csr_agent:rf_source_data -> sample2lvl_converter_0_csr_agent_rsp_fifo:in_data
	wire          sample2lvl_converter_0_csr_agent_rf_source_ready;               // sample2lvl_converter_0_csr_agent_rsp_fifo:in_ready -> sample2lvl_converter_0_csr_agent:rf_source_ready
	wire          sample2lvl_converter_0_csr_agent_rf_source_startofpacket;       // sample2lvl_converter_0_csr_agent:rf_source_startofpacket -> sample2lvl_converter_0_csr_agent_rsp_fifo:in_startofpacket
	wire          sample2lvl_converter_0_csr_agent_rf_source_endofpacket;         // sample2lvl_converter_0_csr_agent:rf_source_endofpacket -> sample2lvl_converter_0_csr_agent_rsp_fifo:in_endofpacket
	wire          sample2lvl_converter_0_csr_agent_rsp_fifo_out_valid;            // sample2lvl_converter_0_csr_agent_rsp_fifo:out_valid -> sample2lvl_converter_0_csr_agent:rf_sink_valid
	wire  [118:0] sample2lvl_converter_0_csr_agent_rsp_fifo_out_data;             // sample2lvl_converter_0_csr_agent_rsp_fifo:out_data -> sample2lvl_converter_0_csr_agent:rf_sink_data
	wire          sample2lvl_converter_0_csr_agent_rsp_fifo_out_ready;            // sample2lvl_converter_0_csr_agent:rf_sink_ready -> sample2lvl_converter_0_csr_agent_rsp_fifo:out_ready
	wire          sample2lvl_converter_0_csr_agent_rsp_fifo_out_startofpacket;    // sample2lvl_converter_0_csr_agent_rsp_fifo:out_startofpacket -> sample2lvl_converter_0_csr_agent:rf_sink_startofpacket
	wire          sample2lvl_converter_0_csr_agent_rsp_fifo_out_endofpacket;      // sample2lvl_converter_0_csr_agent_rsp_fifo:out_endofpacket -> sample2lvl_converter_0_csr_agent:rf_sink_endofpacket
	wire          sample2lvl_converter_0_csr_agent_rdata_fifo_src_valid;          // sample2lvl_converter_0_csr_agent:rdata_fifo_src_valid -> sample2lvl_converter_0_csr_agent_rdata_fifo:in_valid
	wire   [33:0] sample2lvl_converter_0_csr_agent_rdata_fifo_src_data;           // sample2lvl_converter_0_csr_agent:rdata_fifo_src_data -> sample2lvl_converter_0_csr_agent_rdata_fifo:in_data
	wire          sample2lvl_converter_0_csr_agent_rdata_fifo_src_ready;          // sample2lvl_converter_0_csr_agent_rdata_fifo:in_ready -> sample2lvl_converter_0_csr_agent:rdata_fifo_src_ready
	...
	wire  [118:0] onchip_ram_s1_agent_rf_source_data;                             // onchip_RAM_s1_agent:rf_source_data -> onchip_RAM_s1_agent_rsp_fifo:in_data
	...
	wire  [118:0] onchip_ram_s1_agent_rsp_fifo_out_data;                          // onchip_RAM_s1_agent_rsp_fifo:out_data -> onchip_RAM_s1_agent:rf_sink_data
	...
	wire          fir_fifo_out_csr_agent_rp_valid;                                // fir_fifo_out_csr_agent:rp_valid -> router_003:sink_valid
	wire  [117:0] fir_fifo_out_csr_agent_rp_data;                                 // fir_fifo_out_csr_agent:rp_data -> router_003:sink_data
	wire          fir_fifo_out_csr_agent_rp_ready;                                // router_003:sink_ready -> fir_fifo_out_csr_agent:rp_ready
	wire          fir_fifo_out_csr_agent_rp_startofpacket;                        // fir_fifo_out_csr_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          fir_fifo_out_csr_agent_rp_endofpacket;                          // fir_fifo_out_csr_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          fir_fifo_in_csr_agent_rp_valid;                                 // fir_fifo_in_csr_agent:rp_valid -> router_004:sink_valid
	wire  [117:0] fir_fifo_in_csr_agent_rp_data;                                  // fir_fifo_in_csr_agent:rp_data -> router_004:sink_data
	wire          fir_fifo_in_csr_agent_rp_ready;                                 // router_004:sink_ready -> fir_fifo_in_csr_agent:rp_ready
	wire          fir_fifo_in_csr_agent_rp_startofpacket;                         // fir_fifo_in_csr_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          fir_fifo_in_csr_agent_rp_endofpacket;                           // fir_fifo_in_csr_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          sgdma_st2mm_csr_agent_rp_valid;                                 // sgdma_st2mm_csr_agent:rp_valid -> router_005:sink_valid
	wire  [117:0] sgdma_st2mm_csr_agent_rp_data;                                  // sgdma_st2mm_csr_agent:rp_data -> router_005:sink_data
	wire          sgdma_st2mm_csr_agent_rp_ready;                                 // router_005:sink_ready -> sgdma_st2mm_csr_agent:rp_ready
	wire          sgdma_st2mm_csr_agent_rp_startofpacket;                         // sgdma_st2mm_csr_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          sgdma_st2mm_csr_agent_rp_endofpacket;                           // sgdma_st2mm_csr_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          sgdma_mm2st_csr_agent_rp_valid;                                 // sgdma_mm2st_csr_agent:rp_valid -> router_006:sink_valid
	wire  [117:0] sgdma_mm2st_csr_agent_rp_data;                                  // sgdma_mm2st_csr_agent:rp_data -> router_006:sink_data
	wire          sgdma_mm2st_csr_agent_rp_ready;                                 // router_006:sink_ready -> sgdma_mm2st_csr_agent:rp_ready
	wire          sgdma_mm2st_csr_agent_rp_startofpacket;                         // sgdma_mm2st_csr_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          sgdma_mm2st_csr_agent_rp_endofpacket;                           // sgdma_mm2st_csr_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          sample2lvl_converter_0_csr_agent_rp_valid;                      // sample2lvl_converter_0_csr_agent:rp_valid -> router_007:sink_valid
	wire  [117:0] sample2lvl_converter_0_csr_agent_rp_data;                       // sample2lvl_converter_0_csr_agent:rp_data -> router_007:sink_data
	wire          sample2lvl_converter_0_csr_agent_rp_ready;                      // router_007:sink_ready -> sample2lvl_converter_0_csr_agent:rp_ready
	wire          sample2lvl_converter_0_csr_agent_rp_startofpacket;              // sample2lvl_converter_0_csr_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          sample2lvl_converter_0_csr_agent_rp_endofpacket;                // sample2lvl_converter_0_csr_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [117:0] led_pio_s1_agent_rp_data;                                       // led_pio_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [117:0] dipsw_pio_s1_agent_rp_data;                                     // dipsw_pio_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [117:0] button_pio_s1_agent_rp_data;                                    // button_pio_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [117:0] onchip_ram_s1_agent_rp_data;                                    // onchip_RAM_s1_agent:rp_data -> router_011:sink_data
	...
	wire    [9:0] cmd_mux_src_channel;                                            // cmd_mux:src_channel -> sysid_qsys_control_slave_burst_adapter:sink0_channel
	...
	wire          cmd_mux_001_src_valid;                                          // cmd_mux_001:src_valid -> fir_fifo_out_csr_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_001_src_data;                                           // cmd_mux_001:src_data -> fir_fifo_out_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                          // fir_fifo_out_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [9:0] cmd_mux_001_src_channel;                                        // cmd_mux_001:src_channel -> fir_fifo_out_csr_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                  // cmd_mux_001:src_startofpacket -> fir_fifo_out_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                    // cmd_mux_001:src_endofpacket -> fir_fifo_out_csr_burst_adapter:sink0_endofpacket
	wire          fir_fifo_out_csr_burst_adapter_source0_valid;                   // fir_fifo_out_csr_burst_adapter:source0_valid -> fir_fifo_out_csr_agent:cp_valid
	wire  [117:0] fir_fifo_out_csr_burst_adapter_source0_data;                    // fir_fifo_out_csr_burst_adapter:source0_data -> fir_fifo_out_csr_agent:cp_data
	wire          fir_fifo_out_csr_burst_adapter_source0_ready;                   // fir_fifo_out_csr_agent:cp_ready -> fir_fifo_out_csr_burst_adapter:source0_ready
	wire    [9:0] fir_fifo_out_csr_burst_adapter_source0_channel;                 // fir_fifo_out_csr_burst_adapter:source0_channel -> fir_fifo_out_csr_agent:cp_channel
	wire          fir_fifo_out_csr_burst_adapter_source0_startofpacket;           // fir_fifo_out_csr_burst_adapter:source0_startofpacket -> fir_fifo_out_csr_agent:cp_startofpacket
	wire          fir_fifo_out_csr_burst_adapter_source0_endofpacket;             // fir_fifo_out_csr_burst_adapter:source0_endofpacket -> fir_fifo_out_csr_agent:cp_endofpacket
	wire          cmd_mux_002_src_valid;                                          // cmd_mux_002:src_valid -> fir_fifo_in_csr_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_002_src_data;                                           // cmd_mux_002:src_data -> fir_fifo_in_csr_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                          // fir_fifo_in_csr_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [9:0] cmd_mux_002_src_channel;                                        // cmd_mux_002:src_channel -> fir_fifo_in_csr_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                  // cmd_mux_002:src_startofpacket -> fir_fifo_in_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                    // cmd_mux_002:src_endofpacket -> fir_fifo_in_csr_burst_adapter:sink0_endofpacket
	wire          fir_fifo_in_csr_burst_adapter_source0_valid;                    // fir_fifo_in_csr_burst_adapter:source0_valid -> fir_fifo_in_csr_agent:cp_valid
	wire  [117:0] fir_fifo_in_csr_burst_adapter_source0_data;                     // fir_fifo_in_csr_burst_adapter:source0_data -> fir_fifo_in_csr_agent:cp_data
	wire          fir_fifo_in_csr_burst_adapter_source0_ready;                    // fir_fifo_in_csr_agent:cp_ready -> fir_fifo_in_csr_burst_adapter:source0_ready
	wire    [9:0] fir_fifo_in_csr_burst_adapter_source0_channel;                  // fir_fifo_in_csr_burst_adapter:source0_channel -> fir_fifo_in_csr_agent:cp_channel
	wire          fir_fifo_in_csr_burst_adapter_source0_startofpacket;            // fir_fifo_in_csr_burst_adapter:source0_startofpacket -> fir_fifo_in_csr_agent:cp_startofpacket
	wire          fir_fifo_in_csr_burst_adapter_source0_endofpacket;              // fir_fifo_in_csr_burst_adapter:source0_endofpacket -> fir_fifo_in_csr_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                          // cmd_mux_003:src_valid -> sgdma_st2mm_csr_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_003_src_data;                                           // cmd_mux_003:src_data -> sgdma_st2mm_csr_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                          // sgdma_st2mm_csr_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [9:0] cmd_mux_003_src_channel;                                        // cmd_mux_003:src_channel -> sgdma_st2mm_csr_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                  // cmd_mux_003:src_startofpacket -> sgdma_st2mm_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                    // cmd_mux_003:src_endofpacket -> sgdma_st2mm_csr_burst_adapter:sink0_endofpacket
	wire          sgdma_st2mm_csr_burst_adapter_source0_valid;                    // sgdma_st2mm_csr_burst_adapter:source0_valid -> sgdma_st2mm_csr_agent:cp_valid
	wire  [117:0] sgdma_st2mm_csr_burst_adapter_source0_data;                     // sgdma_st2mm_csr_burst_adapter:source0_data -> sgdma_st2mm_csr_agent:cp_data
	wire          sgdma_st2mm_csr_burst_adapter_source0_ready;                    // sgdma_st2mm_csr_agent:cp_ready -> sgdma_st2mm_csr_burst_adapter:source0_ready
	wire    [9:0] sgdma_st2mm_csr_burst_adapter_source0_channel;                  // sgdma_st2mm_csr_burst_adapter:source0_channel -> sgdma_st2mm_csr_agent:cp_channel
	wire          sgdma_st2mm_csr_burst_adapter_source0_startofpacket;            // sgdma_st2mm_csr_burst_adapter:source0_startofpacket -> sgdma_st2mm_csr_agent:cp_startofpacket
	wire          sgdma_st2mm_csr_burst_adapter_source0_endofpacket;              // sgdma_st2mm_csr_burst_adapter:source0_endofpacket -> sgdma_st2mm_csr_agent:cp_endofpacket
	wire          cmd_mux_004_src_valid;                                          // cmd_mux_004:src_valid -> sgdma_mm2st_csr_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_004_src_data;                                           // cmd_mux_004:src_data -> sgdma_mm2st_csr_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                          // sgdma_mm2st_csr_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [9:0] cmd_mux_004_src_channel;                                        // cmd_mux_004:src_channel -> sgdma_mm2st_csr_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                  // cmd_mux_004:src_startofpacket -> sgdma_mm2st_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                    // cmd_mux_004:src_endofpacket -> sgdma_mm2st_csr_burst_adapter:sink0_endofpacket
	wire          sgdma_mm2st_csr_burst_adapter_source0_valid;                    // sgdma_mm2st_csr_burst_adapter:source0_valid -> sgdma_mm2st_csr_agent:cp_valid
	wire  [117:0] sgdma_mm2st_csr_burst_adapter_source0_data;                     // sgdma_mm2st_csr_burst_adapter:source0_data -> sgdma_mm2st_csr_agent:cp_data
	wire          sgdma_mm2st_csr_burst_adapter_source0_ready;                    // sgdma_mm2st_csr_agent:cp_ready -> sgdma_mm2st_csr_burst_adapter:source0_ready
	wire    [9:0] sgdma_mm2st_csr_burst_adapter_source0_channel;                  // sgdma_mm2st_csr_burst_adapter:source0_channel -> sgdma_mm2st_csr_agent:cp_channel
	wire          sgdma_mm2st_csr_burst_adapter_source0_startofpacket;            // sgdma_mm2st_csr_burst_adapter:source0_startofpacket -> sgdma_mm2st_csr_agent:cp_startofpacket
	wire          sgdma_mm2st_csr_burst_adapter_source0_endofpacket;              // sgdma_mm2st_csr_burst_adapter:source0_endofpacket -> sgdma_mm2st_csr_agent:cp_endofpacket
	wire          cmd_mux_005_src_valid;                                          // cmd_mux_005:src_valid -> sample2lvl_converter_0_csr_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_005_src_data;                                           // cmd_mux_005:src_data -> sample2lvl_converter_0_csr_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                          // sample2lvl_converter_0_csr_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [9:0] cmd_mux_005_src_channel;                                        // cmd_mux_005:src_channel -> sample2lvl_converter_0_csr_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                  // cmd_mux_005:src_startofpacket -> sample2lvl_converter_0_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                    // cmd_mux_005:src_endofpacket -> sample2lvl_converter_0_csr_burst_adapter:sink0_endofpacket
	wire          sample2lvl_converter_0_csr_burst_adapter_source0_valid;         // sample2lvl_converter_0_csr_burst_adapter:source0_valid -> sample2lvl_converter_0_csr_agent:cp_valid
	wire  [117:0] sample2lvl_converter_0_csr_burst_adapter_source0_data;          // sample2lvl_converter_0_csr_burst_adapter:source0_data -> sample2lvl_converter_0_csr_agent:cp_data
	wire          sample2lvl_converter_0_csr_burst_adapter_source0_ready;         // sample2lvl_converter_0_csr_agent:cp_ready -> sample2lvl_converter_0_csr_burst_adapter:source0_ready
	wire    [9:0] sample2lvl_converter_0_csr_burst_adapter_source0_channel;       // sample2lvl_converter_0_csr_burst_adapter:source0_channel -> sample2lvl_converter_0_csr_agent:cp_channel
	wire          sample2lvl_converter_0_csr_burst_adapter_source0_startofpacket; // sample2lvl_converter_0_csr_burst_adapter:source0_startofpacket -> sample2lvl_converter_0_csr_agent:cp_startofpacket
	wire          sample2lvl_converter_0_csr_burst_adapter_source0_endofpacket;   // sample2lvl_converter_0_csr_burst_adapter:source0_endofpacket -> sample2lvl_converter_0_csr_agent:cp_endofpacket
	wire          cmd_mux_006_src_valid;                                          // cmd_mux_006:src_valid -> led_pio_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_006_src_data;                                           // cmd_mux_006:src_data -> led_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                          // led_pio_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [9:0] cmd_mux_006_src_channel;                                        // cmd_mux_006:src_channel -> led_pio_s1_burst_adapter:sink0_channel
	...
	wire  [117:0] cmd_mux_007_src_data;                                           // cmd_mux_007:src_data -> dipsw_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                          // dipsw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [9:0] cmd_mux_007_src_channel;                                        // cmd_mux_007:src_channel -> dipsw_pio_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_008_src_valid;                                          // cmd_mux_008:src_valid -> button_pio_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_008_src_data;                                           // cmd_mux_008:src_data -> button_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                          // button_pio_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire    [9:0] cmd_mux_008_src_channel;                                        // cmd_mux_008:src_channel -> button_pio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                  // cmd_mux_008:src_startofpacket -> button_pio_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                    // cmd_mux_008:src_endofpacket -> button_pio_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_009_src_valid;                                          // cmd_mux_009:src_valid -> onchip_RAM_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_009_src_data;                                           // cmd_mux_009:src_data -> onchip_RAM_s1_burst_adapter:sink0_data
	wire          cmd_mux_009_src_ready;                                          // onchip_RAM_s1_burst_adapter:sink0_ready -> cmd_mux_009:src_ready
	wire    [9:0] cmd_mux_009_src_channel;                                        // cmd_mux_009:src_channel -> onchip_RAM_s1_burst_adapter:sink0_channel
	wire          cmd_mux_009_src_startofpacket;                                  // cmd_mux_009:src_startofpacket -> onchip_RAM_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                    // cmd_mux_009:src_endofpacket -> onchip_RAM_s1_burst_adapter:sink0_endofpacket
	wire          onchip_ram_s1_burst_adapter_source0_valid;                      // onchip_RAM_s1_burst_adapter:source0_valid -> onchip_RAM_s1_agent:cp_valid
	wire  [117:0] onchip_ram_s1_burst_adapter_source0_data;                       // onchip_RAM_s1_burst_adapter:source0_data -> onchip_RAM_s1_agent:cp_data
	...
	wire          fir_fifo_out_csr_agent_rdata_fifo_out_valid;                    // fir_fifo_out_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] fir_fifo_out_csr_agent_rdata_fifo_out_data;                     // fir_fifo_out_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          fir_fifo_out_csr_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_001:in_0_ready -> fir_fifo_out_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                              // avalon_st_adapter_001:out_0_valid -> fir_fifo_out_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                               // avalon_st_adapter_001:out_0_data -> fir_fifo_out_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                              // fir_fifo_out_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                              // avalon_st_adapter_001:out_0_error -> fir_fifo_out_csr_agent:rdata_fifo_sink_error
	wire          fir_fifo_in_csr_agent_rdata_fifo_out_valid;                     // fir_fifo_in_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] fir_fifo_in_csr_agent_rdata_fifo_out_data;                      // fir_fifo_in_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          fir_fifo_in_csr_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_002:in_0_ready -> fir_fifo_in_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                              // avalon_st_adapter_002:out_0_valid -> fir_fifo_in_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                               // avalon_st_adapter_002:out_0_data -> fir_fifo_in_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                              // fir_fifo_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                              // avalon_st_adapter_002:out_0_error -> fir_fifo_in_csr_agent:rdata_fifo_sink_error
	wire          sgdma_st2mm_csr_agent_rdata_fifo_out_valid;                     // sgdma_st2mm_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] sgdma_st2mm_csr_agent_rdata_fifo_out_data;                      // sgdma_st2mm_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          sgdma_st2mm_csr_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_003:in_0_ready -> sgdma_st2mm_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                              // avalon_st_adapter_003:out_0_valid -> sgdma_st2mm_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                               // avalon_st_adapter_003:out_0_data -> sgdma_st2mm_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                              // sgdma_st2mm_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                              // avalon_st_adapter_003:out_0_error -> sgdma_st2mm_csr_agent:rdata_fifo_sink_error
	wire          sgdma_mm2st_csr_agent_rdata_fifo_out_valid;                     // sgdma_mm2st_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] sgdma_mm2st_csr_agent_rdata_fifo_out_data;                      // sgdma_mm2st_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          sgdma_mm2st_csr_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_004:in_0_ready -> sgdma_mm2st_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                              // avalon_st_adapter_004:out_0_valid -> sgdma_mm2st_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                               // avalon_st_adapter_004:out_0_data -> sgdma_mm2st_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                              // sgdma_mm2st_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                              // avalon_st_adapter_004:out_0_error -> sgdma_mm2st_csr_agent:rdata_fifo_sink_error
	wire          sample2lvl_converter_0_csr_agent_rdata_fifo_out_valid;          // sample2lvl_converter_0_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] sample2lvl_converter_0_csr_agent_rdata_fifo_out_data;           // sample2lvl_converter_0_csr_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          sample2lvl_converter_0_csr_agent_rdata_fifo_out_ready;          // avalon_st_adapter_005:in_0_ready -> sample2lvl_converter_0_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                              // avalon_st_adapter_005:out_0_valid -> sample2lvl_converter_0_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                               // avalon_st_adapter_005:out_0_data -> sample2lvl_converter_0_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                              // sample2lvl_converter_0_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                              // avalon_st_adapter_005:out_0_error -> sample2lvl_converter_0_csr_agent:rdata_fifo_sink_error
	...
	wire          dipsw_pio_s1_agent_rdata_fifo_out_valid;                        // dipsw_pio_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] dipsw_pio_s1_agent_rdata_fifo_out_data;                         // dipsw_pio_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          dipsw_pio_s1_agent_rdata_fifo_out_ready;                        // avalon_st_adapter_007:in_0_ready -> dipsw_pio_s1_agent_rdata_fifo:out_ready
	...
	wire          onchip_ram_s1_agent_rdata_fifo_out_valid;                       // onchip_RAM_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] onchip_ram_s1_agent_rdata_fifo_out_data;                        // onchip_RAM_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_009:in_0_data
	wire          onchip_ram_s1_agent_rdata_fifo_out_ready;                       // avalon_st_adapter_009:in_0_ready -> onchip_RAM_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fir_fifo_out_csr_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fir_fifo_out_csr_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (fir_fifo_out_csr_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (fir_fifo_out_csr_agent_m0_read),               //                         .read
		.uav_write              (fir_fifo_out_csr_agent_m0_write),              //                         .write
		.uav_waitrequest        (fir_fifo_out_csr_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (fir_fifo_out_csr_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (fir_fifo_out_csr_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (fir_fifo_out_csr_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (fir_fifo_out_csr_agent_m0_writedata),          //                         .writedata
		.uav_lock               (fir_fifo_out_csr_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (fir_fifo_out_csr_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (fir_fifo_out_csr_address),                     //      avalon_anti_slave_0.address
		.av_write               (fir_fifo_out_csr_write),                       //                         .write
		.av_read                (fir_fifo_out_csr_read),                        //                         .read
		.av_readdata            (fir_fifo_out_csr_readdata),                    //                         .readdata
		.av_writedata           (fir_fifo_out_csr_writedata),                   //                         .writedata
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
		.av_byteenable          (),                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fir_fifo_in_csr_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fir_fifo_in_csr_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (fir_fifo_in_csr_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (fir_fifo_in_csr_agent_m0_read),                //                         .read
		.uav_write              (fir_fifo_in_csr_agent_m0_write),               //                         .write
		.uav_waitrequest        (fir_fifo_in_csr_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (fir_fifo_in_csr_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (fir_fifo_in_csr_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (fir_fifo_in_csr_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (fir_fifo_in_csr_agent_m0_writedata),           //                         .writedata
		.uav_lock               (fir_fifo_in_csr_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (fir_fifo_in_csr_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (fir_fifo_in_csr_address),                      //      avalon_anti_slave_0.address
		.av_write               (fir_fifo_in_csr_write),                        //                         .write
		.av_read                (fir_fifo_in_csr_read),                         //                         .read
		.av_readdata            (fir_fifo_in_csr_readdata),                     //                         .readdata
		.av_writedata           (fir_fifo_in_csr_writedata),                    //                         .writedata
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
		.av_byteenable          (),                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sgdma_st2mm_csr_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sgdma_st2mm_csr_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (sgdma_st2mm_csr_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (sgdma_st2mm_csr_agent_m0_read),                //                         .read
		.uav_write              (sgdma_st2mm_csr_agent_m0_write),               //                         .write
		.uav_waitrequest        (sgdma_st2mm_csr_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (sgdma_st2mm_csr_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (sgdma_st2mm_csr_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (sgdma_st2mm_csr_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (sgdma_st2mm_csr_agent_m0_writedata),           //                         .writedata
		.uav_lock               (sgdma_st2mm_csr_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (sgdma_st2mm_csr_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (sgdma_st2mm_csr_address),                      //      avalon_anti_slave_0.address
		.av_write               (sgdma_st2mm_csr_write),                        //                         .write
		.av_read                (sgdma_st2mm_csr_read),                         //                         .read
		.av_readdata            (sgdma_st2mm_csr_readdata),                     //                         .readdata
		.av_writedata           (sgdma_st2mm_csr_writedata),                    //                         .writedata
		.av_chipselect          (sgdma_st2mm_csr_chipselect),                   //                         .chipselect
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
		.av_byteenable          (),                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sgdma_mm2st_csr_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sgdma_mm2st_csr_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (sgdma_mm2st_csr_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (sgdma_mm2st_csr_agent_m0_read),                //                         .read
		.uav_write              (sgdma_mm2st_csr_agent_m0_write),               //                         .write
		.uav_waitrequest        (sgdma_mm2st_csr_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (sgdma_mm2st_csr_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (sgdma_mm2st_csr_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (sgdma_mm2st_csr_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (sgdma_mm2st_csr_agent_m0_writedata),           //                         .writedata
		.uav_lock               (sgdma_mm2st_csr_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (sgdma_mm2st_csr_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (sgdma_mm2st_csr_address),                      //      avalon_anti_slave_0.address
		.av_write               (sgdma_mm2st_csr_write),                        //                         .write
		.av_read                (sgdma_mm2st_csr_read),                         //                         .read
		.av_readdata            (sgdma_mm2st_csr_readdata),                     //                         .readdata
		.av_writedata           (sgdma_mm2st_csr_writedata),                    //                         .writedata
		.av_chipselect          (sgdma_mm2st_csr_chipselect),                   //                         .chipselect
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
		.av_byteenable          (),                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sample2lvl_converter_0_csr_translator (
		.clk                    (clk_0_clk_clk),                                     //                      clk.clk
		.reset                  (sysid_qsys_reset_reset_bridge_in_reset_reset),      //                    reset.reset
		.uav_address            (sample2lvl_converter_0_csr_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (sample2lvl_converter_0_csr_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (sample2lvl_converter_0_csr_agent_m0_read),          //                         .read
		.uav_write              (sample2lvl_converter_0_csr_agent_m0_write),         //                         .write
		.uav_waitrequest        (sample2lvl_converter_0_csr_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (sample2lvl_converter_0_csr_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (sample2lvl_converter_0_csr_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (sample2lvl_converter_0_csr_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (sample2lvl_converter_0_csr_agent_m0_writedata),     //                         .writedata
		.uav_lock               (sample2lvl_converter_0_csr_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (sample2lvl_converter_0_csr_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (sample2lvl_converter_0_csr_address),                //      avalon_anti_slave_0.address
		.av_write               (sample2lvl_converter_0_csr_write),                  //                         .write
		.av_read                (sample2lvl_converter_0_csr_read),                   //                         .read
		.av_readdata            (sample2lvl_converter_0_csr_readdata),               //                         .readdata
		.av_writedata           (sample2lvl_converter_0_csr_writedata),              //                         .writedata
		.av_byteenable          (sample2lvl_converter_0_csr_byteenable),             //                         .byteenable
		.av_waitrequest         (sample2lvl_converter_0_csr_waitrequest),            //                         .waitrequest
		.av_chipselect          (sample2lvl_converter_0_csr_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                                  //              (terminated)
		.av_beginbursttransfer  (),                                                  //              (terminated)
		.av_burstcount          (),                                                  //              (terminated)
		.av_readdatavalid       (1'b0),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) fir_fifo_out_csr_agent (
		.clk                     (clk_0_clk_clk),                                        //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (fir_fifo_out_csr_agent_m0_address),                    //              m0.address
		.m0_burstcount           (fir_fifo_out_csr_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (fir_fifo_out_csr_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (fir_fifo_out_csr_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (fir_fifo_out_csr_agent_m0_lock),                       //                .lock
		.m0_readdata             (fir_fifo_out_csr_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (fir_fifo_out_csr_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (fir_fifo_out_csr_agent_m0_read),                       //                .read
		.m0_waitrequest          (fir_fifo_out_csr_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (fir_fifo_out_csr_agent_m0_writedata),                  //                .writedata
		.m0_write                (fir_fifo_out_csr_agent_m0_write),                      //                .write
		.rp_endofpacket          (fir_fifo_out_csr_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (fir_fifo_out_csr_agent_rp_ready),                      //                .ready
		.rp_valid                (fir_fifo_out_csr_agent_rp_valid),                      //                .valid
		.rp_data                 (fir_fifo_out_csr_agent_rp_data),                       //                .data
		.rp_startofpacket        (fir_fifo_out_csr_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (fir_fifo_out_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fir_fifo_out_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fir_fifo_out_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fir_fifo_out_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fir_fifo_out_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fir_fifo_out_csr_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (fir_fifo_out_csr_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (fir_fifo_out_csr_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (fir_fifo_out_csr_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (fir_fifo_out_csr_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (fir_fifo_out_csr_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (fir_fifo_out_csr_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (fir_fifo_out_csr_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (fir_fifo_out_csr_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (fir_fifo_out_csr_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (fir_fifo_out_csr_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                    // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                    //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                     //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                    //                .error
		.rdata_fifo_src_ready    (fir_fifo_out_csr_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fir_fifo_out_csr_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (fir_fifo_out_csr_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                  //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fir_fifo_out_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (fir_fifo_out_csr_agent_rf_source_data),             //        in.data
		.in_valid          (fir_fifo_out_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (fir_fifo_out_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fir_fifo_out_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fir_fifo_out_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fir_fifo_out_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fir_fifo_out_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fir_fifo_out_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fir_fifo_out_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fir_fifo_out_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fir_fifo_out_csr_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fir_fifo_out_csr_agent_rdata_fifo_src_data),   //        in.data
		.in_valid          (fir_fifo_out_csr_agent_rdata_fifo_src_valid),  //          .valid
		.in_ready          (fir_fifo_out_csr_agent_rdata_fifo_src_ready),  //          .ready
		.out_data          (fir_fifo_out_csr_agent_rdata_fifo_out_data),   //       out.data
		.out_valid         (fir_fifo_out_csr_agent_rdata_fifo_out_valid),  //          .valid
		.out_ready         (fir_fifo_out_csr_agent_rdata_fifo_out_ready),  //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) fir_fifo_in_csr_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (fir_fifo_in_csr_agent_m0_address),                    //              m0.address
		.m0_burstcount           (fir_fifo_in_csr_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (fir_fifo_in_csr_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (fir_fifo_in_csr_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (fir_fifo_in_csr_agent_m0_lock),                       //                .lock
		.m0_readdata             (fir_fifo_in_csr_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (fir_fifo_in_csr_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (fir_fifo_in_csr_agent_m0_read),                       //                .read
		.m0_waitrequest          (fir_fifo_in_csr_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (fir_fifo_in_csr_agent_m0_writedata),                  //                .writedata
		.m0_write                (fir_fifo_in_csr_agent_m0_write),                      //                .write
		.rp_endofpacket          (fir_fifo_in_csr_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (fir_fifo_in_csr_agent_rp_ready),                      //                .ready
		.rp_valid                (fir_fifo_in_csr_agent_rp_valid),                      //                .valid
		.rp_data                 (fir_fifo_in_csr_agent_rp_data),                       //                .data
		.rp_startofpacket        (fir_fifo_in_csr_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (fir_fifo_in_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fir_fifo_in_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fir_fifo_in_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fir_fifo_in_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fir_fifo_in_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fir_fifo_in_csr_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (fir_fifo_in_csr_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (fir_fifo_in_csr_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (fir_fifo_in_csr_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (fir_fifo_in_csr_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (fir_fifo_in_csr_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (fir_fifo_in_csr_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (fir_fifo_in_csr_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (fir_fifo_in_csr_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (fir_fifo_in_csr_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (fir_fifo_in_csr_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (fir_fifo_in_csr_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fir_fifo_in_csr_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (fir_fifo_in_csr_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fir_fifo_in_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (fir_fifo_in_csr_agent_rf_source_data),             //        in.data
		.in_valid          (fir_fifo_in_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (fir_fifo_in_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fir_fifo_in_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fir_fifo_in_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fir_fifo_in_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fir_fifo_in_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fir_fifo_in_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fir_fifo_in_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fir_fifo_in_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fir_fifo_in_csr_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fir_fifo_in_csr_agent_rdata_fifo_src_data),    //        in.data
		.in_valid          (fir_fifo_in_csr_agent_rdata_fifo_src_valid),   //          .valid
		.in_ready          (fir_fifo_in_csr_agent_rdata_fifo_src_ready),   //          .ready
		.out_data          (fir_fifo_in_csr_agent_rdata_fifo_out_data),    //       out.data
		.out_valid         (fir_fifo_in_csr_agent_rdata_fifo_out_valid),   //          .valid
		.out_ready         (fir_fifo_in_csr_agent_rdata_fifo_out_ready),   //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) sgdma_st2mm_csr_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (sgdma_st2mm_csr_agent_m0_address),                    //              m0.address
		.m0_burstcount           (sgdma_st2mm_csr_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (sgdma_st2mm_csr_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (sgdma_st2mm_csr_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (sgdma_st2mm_csr_agent_m0_lock),                       //                .lock
		.m0_readdata             (sgdma_st2mm_csr_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (sgdma_st2mm_csr_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (sgdma_st2mm_csr_agent_m0_read),                       //                .read
		.m0_waitrequest          (sgdma_st2mm_csr_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (sgdma_st2mm_csr_agent_m0_writedata),                  //                .writedata
		.m0_write                (sgdma_st2mm_csr_agent_m0_write),                      //                .write
		.rp_endofpacket          (sgdma_st2mm_csr_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (sgdma_st2mm_csr_agent_rp_ready),                      //                .ready
		.rp_valid                (sgdma_st2mm_csr_agent_rp_valid),                      //                .valid
		.rp_data                 (sgdma_st2mm_csr_agent_rp_data),                       //                .data
		.rp_startofpacket        (sgdma_st2mm_csr_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (sgdma_st2mm_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (sgdma_st2mm_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (sgdma_st2mm_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (sgdma_st2mm_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (sgdma_st2mm_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (sgdma_st2mm_csr_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (sgdma_st2mm_csr_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (sgdma_st2mm_csr_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (sgdma_st2mm_csr_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (sgdma_st2mm_csr_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (sgdma_st2mm_csr_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (sgdma_st2mm_csr_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (sgdma_st2mm_csr_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (sgdma_st2mm_csr_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (sgdma_st2mm_csr_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (sgdma_st2mm_csr_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (sgdma_st2mm_csr_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sgdma_st2mm_csr_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (sgdma_st2mm_csr_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sgdma_st2mm_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (sgdma_st2mm_csr_agent_rf_source_data),             //        in.data
		.in_valid          (sgdma_st2mm_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (sgdma_st2mm_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sgdma_st2mm_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sgdma_st2mm_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sgdma_st2mm_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sgdma_st2mm_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sgdma_st2mm_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sgdma_st2mm_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sgdma_st2mm_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sgdma_st2mm_csr_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sgdma_st2mm_csr_agent_rdata_fifo_src_data),    //        in.data
		.in_valid          (sgdma_st2mm_csr_agent_rdata_fifo_src_valid),   //          .valid
		.in_ready          (sgdma_st2mm_csr_agent_rdata_fifo_src_ready),   //          .ready
		.out_data          (sgdma_st2mm_csr_agent_rdata_fifo_out_data),    //       out.data
		.out_valid         (sgdma_st2mm_csr_agent_rdata_fifo_out_valid),   //          .valid
		.out_ready         (sgdma_st2mm_csr_agent_rdata_fifo_out_ready),   //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) sgdma_mm2st_csr_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (sgdma_mm2st_csr_agent_m0_address),                    //              m0.address
		.m0_burstcount           (sgdma_mm2st_csr_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (sgdma_mm2st_csr_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (sgdma_mm2st_csr_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (sgdma_mm2st_csr_agent_m0_lock),                       //                .lock
		.m0_readdata             (sgdma_mm2st_csr_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (sgdma_mm2st_csr_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (sgdma_mm2st_csr_agent_m0_read),                       //                .read
		.m0_waitrequest          (sgdma_mm2st_csr_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (sgdma_mm2st_csr_agent_m0_writedata),                  //                .writedata
		.m0_write                (sgdma_mm2st_csr_agent_m0_write),                      //                .write
		.rp_endofpacket          (sgdma_mm2st_csr_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (sgdma_mm2st_csr_agent_rp_ready),                      //                .ready
		.rp_valid                (sgdma_mm2st_csr_agent_rp_valid),                      //                .valid
		.rp_data                 (sgdma_mm2st_csr_agent_rp_data),                       //                .data
		.rp_startofpacket        (sgdma_mm2st_csr_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (sgdma_mm2st_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (sgdma_mm2st_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (sgdma_mm2st_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (sgdma_mm2st_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (sgdma_mm2st_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (sgdma_mm2st_csr_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (sgdma_mm2st_csr_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (sgdma_mm2st_csr_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (sgdma_mm2st_csr_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (sgdma_mm2st_csr_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (sgdma_mm2st_csr_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (sgdma_mm2st_csr_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (sgdma_mm2st_csr_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (sgdma_mm2st_csr_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (sgdma_mm2st_csr_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (sgdma_mm2st_csr_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (sgdma_mm2st_csr_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sgdma_mm2st_csr_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (sgdma_mm2st_csr_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sgdma_mm2st_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (sgdma_mm2st_csr_agent_rf_source_data),             //        in.data
		.in_valid          (sgdma_mm2st_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (sgdma_mm2st_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sgdma_mm2st_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sgdma_mm2st_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sgdma_mm2st_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sgdma_mm2st_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sgdma_mm2st_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sgdma_mm2st_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sgdma_mm2st_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sgdma_mm2st_csr_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sgdma_mm2st_csr_agent_rdata_fifo_src_data),    //        in.data
		.in_valid          (sgdma_mm2st_csr_agent_rdata_fifo_src_valid),   //          .valid
		.in_ready          (sgdma_mm2st_csr_agent_rdata_fifo_src_ready),   //          .ready
		.out_data          (sgdma_mm2st_csr_agent_rdata_fifo_out_data),    //       out.data
		.out_valid         (sgdma_mm2st_csr_agent_rdata_fifo_out_valid),   //          .valid
		.out_ready         (sgdma_mm2st_csr_agent_rdata_fifo_out_ready),   //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) sample2lvl_converter_0_csr_agent (
		.clk                     (clk_0_clk_clk),                                                  //             clk.clk
		.reset                   (sysid_qsys_reset_reset_bridge_in_reset_reset),                   //       clk_reset.reset
		.m0_address              (sample2lvl_converter_0_csr_agent_m0_address),                    //              m0.address
		.m0_burstcount           (sample2lvl_converter_0_csr_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (sample2lvl_converter_0_csr_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (sample2lvl_converter_0_csr_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (sample2lvl_converter_0_csr_agent_m0_lock),                       //                .lock
		.m0_readdata             (sample2lvl_converter_0_csr_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (sample2lvl_converter_0_csr_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (sample2lvl_converter_0_csr_agent_m0_read),                       //                .read
		.m0_waitrequest          (sample2lvl_converter_0_csr_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (sample2lvl_converter_0_csr_agent_m0_writedata),                  //                .writedata
		.m0_write                (sample2lvl_converter_0_csr_agent_m0_write),                      //                .write
		.rp_endofpacket          (sample2lvl_converter_0_csr_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (sample2lvl_converter_0_csr_agent_rp_ready),                      //                .ready
		.rp_valid                (sample2lvl_converter_0_csr_agent_rp_valid),                      //                .valid
		.rp_data                 (sample2lvl_converter_0_csr_agent_rp_data),                       //                .data
		.rp_startofpacket        (sample2lvl_converter_0_csr_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (sample2lvl_converter_0_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (sample2lvl_converter_0_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (sample2lvl_converter_0_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (sample2lvl_converter_0_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (sample2lvl_converter_0_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (sample2lvl_converter_0_csr_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (sample2lvl_converter_0_csr_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (sample2lvl_converter_0_csr_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (sample2lvl_converter_0_csr_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (sample2lvl_converter_0_csr_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (sample2lvl_converter_0_csr_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (sample2lvl_converter_0_csr_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (sample2lvl_converter_0_csr_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (sample2lvl_converter_0_csr_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (sample2lvl_converter_0_csr_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (sample2lvl_converter_0_csr_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                              //                .error
		.rdata_fifo_src_ready    (sample2lvl_converter_0_csr_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sample2lvl_converter_0_csr_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (sample2lvl_converter_0_csr_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sample2lvl_converter_0_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                               //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		.in_data           (sample2lvl_converter_0_csr_agent_rf_source_data),             //        in.data
		.in_valid          (sample2lvl_converter_0_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (sample2lvl_converter_0_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sample2lvl_converter_0_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sample2lvl_converter_0_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sample2lvl_converter_0_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sample2lvl_converter_0_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sample2lvl_converter_0_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sample2lvl_converter_0_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sample2lvl_converter_0_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                       // (terminated)
		.csr_read          (1'b0),                                                        // (terminated)
		.csr_write         (1'b0),                                                        // (terminated)
		.csr_readdata      (),                                                            // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sample2lvl_converter_0_csr_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                         //       clk.clk
		.reset             (sysid_qsys_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (sample2lvl_converter_0_csr_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (sample2lvl_converter_0_csr_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (sample2lvl_converter_0_csr_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (sample2lvl_converter_0_csr_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (sample2lvl_converter_0_csr_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (sample2lvl_converter_0_csr_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                                 // (terminated)
		.csr_read          (1'b0),                                                  // (terminated)
		.csr_write         (1'b0),                                                  // (terminated)
		.csr_readdata      (),                                                      // (terminated)
	...
	soc_system_mm_interconnect_1_router_002 router_003 (
		.sink_ready         (fir_fifo_out_csr_agent_rp_ready),              //      sink.ready
		.sink_valid         (fir_fifo_out_csr_agent_rp_valid),              //          .valid
		.sink_data          (fir_fifo_out_csr_agent_rp_data),               //          .data
		.sink_startofpacket (fir_fifo_out_csr_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (fir_fifo_out_csr_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_004 (
		.sink_ready         (fir_fifo_in_csr_agent_rp_ready),               //      sink.ready
		.sink_valid         (fir_fifo_in_csr_agent_rp_valid),               //          .valid
		.sink_data          (fir_fifo_in_csr_agent_rp_data),                //          .data
		.sink_startofpacket (fir_fifo_in_csr_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (fir_fifo_in_csr_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_005 (
		.sink_ready         (sgdma_st2mm_csr_agent_rp_ready),               //      sink.ready
		.sink_valid         (sgdma_st2mm_csr_agent_rp_valid),               //          .valid
		.sink_data          (sgdma_st2mm_csr_agent_rp_data),                //          .data
		.sink_startofpacket (sgdma_st2mm_csr_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (sgdma_st2mm_csr_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_006 (
		.sink_ready         (sgdma_mm2st_csr_agent_rp_ready),               //      sink.ready
		.sink_valid         (sgdma_mm2st_csr_agent_rp_valid),               //          .valid
		.sink_data          (sgdma_mm2st_csr_agent_rp_data),                //          .data
		.sink_startofpacket (sgdma_mm2st_csr_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (sgdma_mm2st_csr_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_007 (
		.sink_ready         (sample2lvl_converter_0_csr_agent_rp_ready),         //      sink.ready
		.sink_valid         (sample2lvl_converter_0_csr_agent_rp_valid),         //          .valid
		.sink_data          (sample2lvl_converter_0_csr_agent_rp_data),          //          .data
		.sink_startofpacket (sample2lvl_converter_0_csr_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (sample2lvl_converter_0_csr_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (sysid_qsys_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) fir_fifo_out_csr_burst_adapter (
		.clk                   (clk_0_clk_clk),                                        //       cr0.clk
		.reset                 (sysid_qsys_reset_reset_bridge_in_reset_reset),         // cr0_reset.reset
		...
		.source0_valid         (fir_fifo_out_csr_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fir_fifo_out_csr_burst_adapter_source0_data),          //          .data
		.source0_channel       (fir_fifo_out_csr_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fir_fifo_out_csr_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fir_fifo_out_csr_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fir_fifo_out_csr_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (fir_fifo_in_csr_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fir_fifo_in_csr_burst_adapter_source0_data),          //          .data
		.source0_channel       (fir_fifo_in_csr_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fir_fifo_in_csr_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fir_fifo_in_csr_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fir_fifo_in_csr_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (sgdma_st2mm_csr_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (sgdma_st2mm_csr_burst_adapter_source0_data),          //          .data
		.source0_channel       (sgdma_st2mm_csr_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (sgdma_st2mm_csr_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (sgdma_st2mm_csr_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (sgdma_st2mm_csr_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (sgdma_mm2st_csr_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (sgdma_mm2st_csr_burst_adapter_source0_data),          //          .data
		.source0_channel       (sgdma_mm2st_csr_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (sgdma_mm2st_csr_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (sgdma_mm2st_csr_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (sgdma_mm2st_csr_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) sample2lvl_converter_0_csr_burst_adapter (
		.clk                   (clk_0_clk_clk),                                                  //       cr0.clk
		.reset                 (sysid_qsys_reset_reset_bridge_in_reset_reset),                   // cr0_reset.reset
		...
		.source0_valid         (sample2lvl_converter_0_csr_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (sample2lvl_converter_0_csr_burst_adapter_source0_data),          //          .data
		.source0_channel       (sample2lvl_converter_0_csr_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (sample2lvl_converter_0_csr_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (sample2lvl_converter_0_csr_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (sample2lvl_converter_0_csr_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fir_fifo_out_csr_agent_rdata_fifo_out_data),   //     in_0.data
		.in_0_valid     (fir_fifo_out_csr_agent_rdata_fifo_out_valid),  //         .valid
		.in_0_ready     (fir_fifo_out_csr_agent_rdata_fifo_out_ready),  //         .ready
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fir_fifo_in_csr_agent_rdata_fifo_out_data),    //     in_0.data
		.in_0_valid     (fir_fifo_in_csr_agent_rdata_fifo_out_valid),   //         .valid
		.in_0_ready     (fir_fifo_in_csr_agent_rdata_fifo_out_ready),   //         .ready
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sgdma_st2mm_csr_agent_rdata_fifo_out_data),    //     in_0.data
		.in_0_valid     (sgdma_st2mm_csr_agent_rdata_fifo_out_valid),   //         .valid
		.in_0_ready     (sgdma_st2mm_csr_agent_rdata_fifo_out_ready),   //         .ready
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sgdma_mm2st_csr_agent_rdata_fifo_out_data),    //     in_0.data
		.in_0_valid     (sgdma_mm2st_csr_agent_rdata_fifo_out_valid),   //         .valid
		.in_0_ready     (sgdma_mm2st_csr_agent_rdata_fifo_out_ready),   //         .ready
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                         // in_clk_0.clk
		.in_rst_0_reset (sysid_qsys_reset_reset_bridge_in_reset_reset),          // in_rst_0.reset
		.in_0_data      (sample2lvl_converter_0_csr_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (sample2lvl_converter_0_csr_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (sample2lvl_converter_0_csr_agent_rdata_fifo_out_ready), //         .ready
