...
ensure_lib                                                ./libraries/st2mm_data_adapter_0/                          
vmap       st2mm_data_adapter_0                           ./libraries/st2mm_data_adapter_0/                          
...
ensure_lib                                                ./libraries/sample2lvl_converter_0/                        
vmap       sample2lvl_converter_0                         ./libraries/sample2lvl_converter_0/                        
...
ensure_lib                                                ./libraries/mm2st_data_adapter_0/                          
vmap       mm2st_data_adapter_0                           ./libraries/mm2st_data_adapter_0/                          
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                    -L altera_common_sv_packages -work sysid_qsys_control_slave_burst_adapter        
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                      -L altera_common_sv_packages -work sysid_qsys_control_slave_agent                
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                 -L altera_common_sv_packages -work sysid_qsys_control_slave_translator           
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                -L altera_common_sv_packages -work sgdma_mm2st_descriptor_write_rsp_width_adapter
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                               -L altera_common_sv_packages -work sgdma_mm2st_descriptor_write_rsp_width_adapter
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                  -L altera_common_sv_packages -work sgdma_mm2st_descriptor_read_limiter           
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                  -L altera_common_sv_packages -work sgdma_mm2st_descriptor_read_limiter           
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                     -L altera_common_sv_packages -work sgdma_mm2st_descriptor_read_agent             
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_5.v"                                                                 -work mm_interconnect_5                             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/st2mm_data_adapter.sv"                                             -L altera_common_sv_packages -work st2mm_data_adapter_0                          
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/signal_buffer_ctrl.sv"                                             -L altera_common_sv_packages -work signal_buffer_ctrl                            
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_signal_buffer.v"                                                                     -work signal_buffer                                 
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_sgdma_st2mm.v"                                                                       -work sgdma_st2mm                                   
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_sgdma_mm2st.v"                                                                       -work sgdma_mm2st                                   
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sample2lvl_converter.sv"                                           -L altera_common_sv_packages -work sample2lvl_converter_0                        
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/lvl_generator.sv"                                                  -L altera_common_sv_packages -work sample2lvl_converter_0                        
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sample_dispatcher.sv"                                              -L altera_common_sv_packages -work sample2lvl_converter_0                        
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/output_ctrl.sv"                                                    -L altera_common_sv_packages -work output_ctrl                                   
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_onchip_RAM.v"                                                                        -work onchip_RAM                                    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mm2st_data_adapter.sv"                                             -L altera_common_sv_packages -work mm2st_data_adapter_0                          
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/limits_buffer_ctrl.sv"                                             -L altera_common_sv_packages -work limits_buffer_ctrl                            
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_limits_buffer.v"                                                                     -work limits_buffer                                 
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/iteration_ctrl.sv"                                                 -L altera_common_sv_packages -work iteration_ctrl                                
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/hard_limiter.sv"                                                   -L altera_common_sv_packages -work hard_limiter                                  
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                                        -work fir_filter                                    
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                                        -work fir_fifo_in                                   
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fir_driver.sv"                                                     -L altera_common_sv_packages -work fir_driver                                    
