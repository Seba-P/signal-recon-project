...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/signal_buffer.sv"                                                  -L altera_common_sv_packages -work signal_buffer                                 
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sample2lvl_converter.sv"                                           -L altera_common_sv_packages -work sample2lvl_converter                          
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/lvl_generator.sv"                                                  -L altera_common_sv_packages -work sample2lvl_converter                          
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sample_dispatcher.sv"                                              -L altera_common_sv_packages -work sample2lvl_converter                          
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/limits_buffer.sv"                                                  -L altera_common_sv_packages -work limits_buffer                                 
