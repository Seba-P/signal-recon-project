...
% ================================================================================
% Generated on: 05/30/2018 10:56:59
...
for j = 1:sx
    ...
    %
    file_name = ['soc_system_fir_filter_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = soc_system_fir_filter_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['soc_system_fir_filter_model_output'];
