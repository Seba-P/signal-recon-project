...
mkdir -p ./libraries/sysid_qsys_control_slave_burst_adapter/
mkdir -p ./libraries/router_002/
mkdir -p ./libraries/router/
mkdir -p ./libraries/sysid_qsys_control_slave_agent/
mkdir -p ./libraries/hps_0_h2f_lw_axi_master_agent/
mkdir -p ./libraries/sysid_qsys_control_slave_translator/
mkdir -p ./libraries/sgdma_mm2st_descriptor_write_rsp_width_adapter/
mkdir -p ./libraries/sgdma_mm2st_descriptor_read_limiter/
mkdir -p ./libraries/router_006/
mkdir -p ./libraries/router_004/
mkdir -p ./libraries/hps_0_f2h_axi_slave_agent/
mkdir -p ./libraries/sgdma_mm2st_descriptor_read_agent/
mkdir -p ./libraries/sgdma_mm2st_descriptor_read_translator/
...
mkdir -p ./libraries/fir_filter/
mkdir -p ./libraries/fir_fifo_in/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/soc_system_onchip_RAM.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                    -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"                             -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                               -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                                -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                                    -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                                    -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                                 -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                                -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                  -work sysid_qsys_control_slave_burst_adapter         -cdslib ./cds_libs/sysid_qsys_control_slave_burst_adapter.cds.lib        
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                      -work sysid_qsys_control_slave_agent                 -cdslib ./cds_libs/sysid_qsys_control_slave_agent.cds.lib                
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                               -work sysid_qsys_control_slave_agent                 -cdslib ./cds_libs/sysid_qsys_control_slave_agent.cds.lib                
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                 -work sysid_qsys_control_slave_translator            -cdslib ./cds_libs/sysid_qsys_control_slave_translator.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                    -work sgdma_mm2st_descriptor_write_rsp_width_adapter -cdslib ./cds_libs/sgdma_mm2st_descriptor_write_rsp_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                -work sgdma_mm2st_descriptor_write_rsp_width_adapter -cdslib ./cds_libs/sgdma_mm2st_descriptor_write_rsp_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                               -work sgdma_mm2st_descriptor_write_rsp_width_adapter -cdslib ./cds_libs/sgdma_mm2st_descriptor_write_rsp_width_adapter.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                  -work sgdma_mm2st_descriptor_read_limiter            -cdslib ./cds_libs/sgdma_mm2st_descriptor_read_limiter.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                   -work sgdma_mm2st_descriptor_read_limiter            -cdslib ./cds_libs/sgdma_mm2st_descriptor_read_limiter.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                           -work sgdma_mm2st_descriptor_read_limiter            -cdslib ./cds_libs/sgdma_mm2st_descriptor_read_limiter.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                  -work sgdma_mm2st_descriptor_read_limiter            -cdslib ./cds_libs/sgdma_mm2st_descriptor_read_limiter.cds.lib           
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_router_004.sv"                        -work router_004                                     -cdslib ./cds_libs/router_004.cds.lib                                    
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                     -work sgdma_mm2st_descriptor_read_agent              -cdslib ./cds_libs/sgdma_mm2st_descriptor_read_agent.cds.lib             
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                -work sgdma_mm2st_descriptor_read_translator         -cdslib ./cds_libs/sgdma_mm2st_descriptor_read_translator.cds.lib        
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/dspba_library_package.vhd"                                         -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/dspba_library.vhd"                                                 -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_math_pkg_hpfir.vhd"                                      -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_lib_pkg_hpfir.vhd"                                       -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_controller_hpfir.vhd"                   -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_sink_hpfir.vhd"                         -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_source_hpfir.vhd"                       -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/auk_dspip_roundsat_hpfir.vhd"                                      -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                           -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_fir_filter_rtl_core.vhd"                                -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_fir_filter_ast.vhd"                                     -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_fir_filter.vhd"                                         -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_fir_filter_tb.vhd"                                      -work fir_filter                                     -cdslib ./cds_libs/fir_filter.cds.lib                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                           -work fir_fifo_in                                    -cdslib ./cds_libs/fir_fifo_in.cds.lib                                   
