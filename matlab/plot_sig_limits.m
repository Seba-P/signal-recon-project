...
%     for i = 1:length(samples)
%         if (samples(i,1))
%             upper_limit = curr_lvl >= N_sig_lvls-1 ? 1 : sig_lvls(curr_lvl+2);
%             lower_limit = sig_lvls(curr_lvl+1);
%             curr_lvl    = curr_lvl == N_sig_lvls ? curr_lvl(N_sig_lvls) : curr_lvl + 1;
%         else
%             upper_limit = sig_lvls(curr_lvl);
%             lower_limit = curr_lvl == 1 ? -1 : sig_lvls(curr_lvl-1);
%             curr_lvl    = curr_lvl == 1 ? 1 : curr_lvl - 1;
%         end
